...
public class GetFullIssuedCardOperation implements RequestOperation<GetFullIssuedCardRequest, GetFullIssuedCardResponse> {
    ...
    public GetFullIssuedCardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetFullIssuedCardRequest request) throws Exception {
