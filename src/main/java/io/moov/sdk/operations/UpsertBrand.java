...
public class UpsertBrand {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpsertBrandRequest, UpsertBrandResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpsertBrandRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpsertBrandRequest.class, new TypeReference<UpsertBrandRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpsertBrandRequest request) throws Exception {
        ...
        @Override
        public UpsertBrandResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpsertBrandResponse.Builder resBuilder =
                    UpsertBrandResponse
                            .builder()
            ...
            UpsertBrandResponse res = resBuilder.build();
