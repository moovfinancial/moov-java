...
public class CreateScheduleSecurity {
    ...
    public CreateScheduleSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CreateScheduleSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CreateScheduleSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CreateScheduleSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateScheduleSecurity other = (CreateScheduleSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateScheduleSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CreateScheduleSecurity build() {
            return new CreateScheduleSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
