...
public class ListPartnerPricingAgreements {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPartnerPricingAgreementsRequest request) {
        ...
        @Override
        public ListPartnerPricingAgreementsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPartnerPricingAgreements(Utils.unmarshal(response, new TypeReference<List<PartnerPricingAgreement>>() {}));
                } else {
