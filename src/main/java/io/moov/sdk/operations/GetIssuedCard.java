...
public class GetIssuedCard {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetIssuedCardRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetIssuedCardRequest, GetIssuedCardResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetIssuedCardRequest request) throws Exception {
