...
public class ListPaymentLinksSecurity {
    ...
    @JsonCreator
    public ListPaymentLinksSecurity(
    ...
    public ListPaymentLinksSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListPaymentLinksSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListPaymentLinksSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListPaymentLinksSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentLinksSecurity other = (ListPaymentLinksSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentLinksSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListPaymentLinksSecurity build() {
            return new ListPaymentLinksSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
