...
public class GetPaymentMethodSecurity {
    ...
    @JsonCreator
    public GetPaymentMethodSecurity(
    ...
    public GetPaymentMethodSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetPaymentMethodSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetPaymentMethodSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetPaymentMethodSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentMethodSecurity other = (GetPaymentMethodSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentMethodSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetPaymentMethodSecurity build() {
            return new GetPaymentMethodSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
