...
public class ListDisputes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDisputesRequest request) {
        ...
        @Override
        public ListDisputesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDisputes(Utils.unmarshal(response, new TypeReference<List<Dispute>>() {}));
                } else {
