...
public class PingOperation implements RequestOperation<PingRequest, PingResponse> {
    ...
    public PingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PingRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PingRequest request) throws Exception {
        HttpRequest r = buildRequest(request);
        HttpResponse<InputStream> httpRes;
        try {
            httpRes = client.send(r);
            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "429", "4XX", "500", "5XX")) {
    ...
    @Override
    public PingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        PingResponse.Builder resBuilder = 
            PingResponse
                .builder()
        ...
        PingResponse res = resBuilder.build();
