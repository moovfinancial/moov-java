...
public class DisableProduct {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableProductRequest, DisableProductResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DisableProductRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableProductRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisableProductRequest request) throws Exception {
        ...
        @Override
        public DisableProductResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisableProductResponse.Builder resBuilder =
            ...
            DisableProductResponse res = resBuilder.build();
