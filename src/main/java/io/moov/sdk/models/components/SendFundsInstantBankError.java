...
public class SendFundsInstantBankError {
    ...
    @JsonCreator
    public SendFundsInstantBankError(
    ...
    public SendFundsInstantBankError withEstimatedActivity(EstimatedActivityError estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
    ...
    public SendFundsInstantBankError withEstimatedActivity(Optional<? extends EstimatedActivityError> estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
        this.estimatedActivity = estimatedActivity;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SendFundsInstantBankError other = (SendFundsInstantBankError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SendFundsInstantBankError.class,
    ...
    public final static class Builder {
        ...
        public SendFundsInstantBankError build() {

            return new SendFundsInstantBankError(
                estimatedActivity);
        }
