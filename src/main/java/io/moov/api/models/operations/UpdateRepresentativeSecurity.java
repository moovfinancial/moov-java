...
public class UpdateRepresentativeSecurity {
    ...
    @JsonCreator
    public UpdateRepresentativeSecurity(
    ...
    public UpdateRepresentativeSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdateRepresentativeSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdateRepresentativeSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdateRepresentativeSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateRepresentativeSecurity other = (UpdateRepresentativeSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateRepresentativeSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdateRepresentativeSecurity build() {
            return new UpdateRepresentativeSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
