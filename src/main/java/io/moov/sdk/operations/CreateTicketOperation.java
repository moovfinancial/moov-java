...
public class CreateTicketOperation implements RequestOperation<CreateTicketRequest, CreateTicketResponse> {
    ...
    public CreateTicketOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTicketRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreateTicketRequest request) throws Exception {
    ...
    @Override
    public CreateTicketResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreateTicketResponse.Builder resBuilder = 
        ...
        CreateTicketResponse res = resBuilder.build();
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                CreateTicketError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
