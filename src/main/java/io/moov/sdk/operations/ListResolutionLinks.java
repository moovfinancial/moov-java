...
public class ListResolutionLinks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListResolutionLinksRequest, ListResolutionLinksResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListResolutionLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListResolutionLinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListResolutionLinksRequest request) {
        ...
        @Override
        public ListResolutionLinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListResolutionLinksResponse.Builder resBuilder =
            ...
            ListResolutionLinksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResolutionLinks(Utils.unmarshal(response, new TypeReference<List<ResolutionLink>>() {}));
                } else {
