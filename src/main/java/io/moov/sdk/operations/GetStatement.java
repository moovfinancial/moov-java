...
public class GetStatement {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStatementRequest request) {
        ...
        @Override
        public GetStatementResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStatement(Utils.unmarshal(response, new TypeReference<Statement>() {}));
