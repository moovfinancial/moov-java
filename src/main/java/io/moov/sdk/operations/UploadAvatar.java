...
public class UploadAvatar {
    ...
    static abstract class Base {
        ...
        final UploadAvatarSecurity security;
        final SecuritySource securitySource;
        final HTTPClient client;
        final Headers _headers;

        public Base(
                SDKConfiguration sdkConfiguration, UploadAvatarSecurity security,
                Headers _headers) {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadAvatarRequest, UploadAvatarResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, UploadAvatarSecurity security,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UploadAvatarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadAvatarRequest.class, new TypeReference<UploadAvatarRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadAvatarRequest request) {
        ...
        @Override
        public UploadAvatarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadAvatarResponse.Builder resBuilder =
            ...
            UploadAvatarResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "404", "413", "415", "429")) {
                res.withHeaders(response.headers().map());
                // no content
