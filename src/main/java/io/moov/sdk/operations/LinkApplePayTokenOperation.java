...
public class LinkApplePayTokenOperation implements RequestOperation<LinkApplePayTokenRequest, LinkApplePayTokenResponse> {
    ...
    public LinkApplePayTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(LinkApplePayTokenRequest request) throws Exception {
