...
public class GetPaymentLinkQRCodeSecurity {
    ...
    @JsonCreator
    public GetPaymentLinkQRCodeSecurity(
    ...
    public GetPaymentLinkQRCodeSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetPaymentLinkQRCodeSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetPaymentLinkQRCodeSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetPaymentLinkQRCodeSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkQRCodeSecurity other = (GetPaymentLinkQRCodeSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkQRCodeSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetPaymentLinkQRCodeSecurity build() {
            return new GetPaymentLinkQRCodeSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
