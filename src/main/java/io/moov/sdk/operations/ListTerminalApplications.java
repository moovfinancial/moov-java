...
public class ListTerminalApplications {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListTerminalApplicationsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTerminalApplicationsRequest, ListTerminalApplicationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListTerminalApplicationsRequest request) throws Exception {
