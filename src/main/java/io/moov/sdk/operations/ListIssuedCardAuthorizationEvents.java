...
public class ListIssuedCardAuthorizationEvents {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListIssuedCardAuthorizationEventsRequest request) {
        ...
        @Override
        public ListIssuedCardAuthorizationEventsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIssuedCardAuthorizationEvents(Utils.unmarshal(response, new TypeReference<List<IssuedCardAuthorizationEvent>>() {}));
                } else {
