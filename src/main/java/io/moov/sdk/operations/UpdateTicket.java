...
public class UpdateTicket {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketRequest, UpdateTicketResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketRequest.class, new TypeReference<UpdateTicketRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketRequest request) throws Exception {
        ...
        @Override
        public UpdateTicketResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketResponse.Builder resBuilder =
            ...
            UpdateTicketResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Ticket out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicket(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateTicketError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
