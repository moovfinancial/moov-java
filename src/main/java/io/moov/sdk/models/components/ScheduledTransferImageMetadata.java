...
public class ScheduledTransferImageMetadata {
    ...
    @JsonCreator
    public ScheduledTransferImageMetadata(
     ...
     * Unique identifier for a image resource.
     */
    public ScheduledTransferImageMetadata withImageID(String imageID) {
        Utils.checkNotNull(imageID, "imageID");
        this.imageID = imageID;
        return this;
    }
     ...
     * Alternative text for the image.
     */
    public ScheduledTransferImageMetadata withAltText(String altText) {
        Utils.checkNotNull(altText, "altText");
     ...
     * Alternative text for the image.
     */
    public ScheduledTransferImageMetadata withAltText(Optional<String> altText) {
        Utils.checkNotNull(altText, "altText");
        this.altText = altText;
        return this;
    }
     ...
     * The image's public URL.
     */
    public ScheduledTransferImageMetadata withLink(String link) {
        Utils.checkNotNull(link, "link");
        this.link = link;
        return this;
    }
     ...
     * A unique identifier for an image, used in public image links.
     */
    public ScheduledTransferImageMetadata withPublicID(String publicID) {
        Utils.checkNotNull(publicID, "publicID");
        this.publicID = publicID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ScheduledTransferImageMetadata other = (ScheduledTransferImageMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ScheduledTransferImageMetadata.class,
                "imageID", imageID,
                "altText", altText,
                "link", link,
                "publicID", publicID);
    ...
    public final static class Builder {
        ...
        public ScheduledTransferImageMetadata build() {

            return new ScheduledTransferImageMetadata(
                imageID, altText, link,
                publicID);
        }
