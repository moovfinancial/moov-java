...
public class UpsertUnderwritingOperation implements RequestOperation<UpsertUnderwritingRequest, UpsertUnderwritingResponse> {
    ...
    public UpsertUnderwritingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpsertUnderwritingRequest request) throws Exception {
