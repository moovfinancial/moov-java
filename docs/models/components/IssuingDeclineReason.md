...
```java
import io.moov.sdk.models.components.IssuingDeclineReason;

IssuingDeclineReason value = IssuingDeclineReason.INSUFFICIENT_FUNDS;

// Open enum: use .of() to create instances from custom string values
IssuingDeclineReason custom = IssuingDeclineReason.of("custom_value");
```
