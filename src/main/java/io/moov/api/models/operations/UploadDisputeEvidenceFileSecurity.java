...
public class UploadDisputeEvidenceFileSecurity {
    ...
    @JsonCreator
    public UploadDisputeEvidenceFileSecurity(
    ...
    public UploadDisputeEvidenceFileSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UploadDisputeEvidenceFileSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UploadDisputeEvidenceFileSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UploadDisputeEvidenceFileSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UploadDisputeEvidenceFileSecurity other = (UploadDisputeEvidenceFileSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UploadDisputeEvidenceFileSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UploadDisputeEvidenceFileSecurity build() {
            return new UploadDisputeEvidenceFileSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
