...
public class ListResidualFees {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListResidualFeesRequest, ListResidualFeesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListResidualFeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListResidualFeesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListResidualFeesRequest request) {
        ...
        @Override
        public ListResidualFeesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListResidualFeesResponse.Builder resBuilder =
            ...
            ListResidualFeesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIncurredFees(Utils.unmarshal(response, new TypeReference<List<IncurredFee>>() {}));
                } else {
