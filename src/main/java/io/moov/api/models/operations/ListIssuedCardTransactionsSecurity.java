...
public class ListIssuedCardTransactionsSecurity {
    ...
    @JsonCreator
    public ListIssuedCardTransactionsSecurity(
    ...
    public ListIssuedCardTransactionsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListIssuedCardTransactionsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListIssuedCardTransactionsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListIssuedCardTransactionsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListIssuedCardTransactionsSecurity other = (ListIssuedCardTransactionsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListIssuedCardTransactionsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListIssuedCardTransactionsSecurity build() {
            return new ListIssuedCardTransactionsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
