...
public class CardPaymentOptions {
    /**
     ...
     * enabled by Moov to set this field.
     */
    public CardPaymentOptions withDynamicDescriptor(String dynamicDescriptor) {
        Utils.checkNotNull(dynamicDescriptor, "dynamicDescriptor");
     ...
     * enabled by Moov to set this field.
     */
    public CardPaymentOptions withDynamicDescriptor(Optional<String> dynamicDescriptor) {
        Utils.checkNotNull(dynamicDescriptor, "dynamicDescriptor");
        this.dynamicDescriptor = dynamicDescriptor;
        return this;
    }
     ...
     * Omit for customer-initiated e-commerce transactions.
     */
    public CardPaymentOptions withTransactionSource(TransactionSource transactionSource) {
        Utils.checkNotNull(transactionSource, "transactionSource");
     ...
     * Omit for customer-initiated e-commerce transactions.
     */
    public CardPaymentOptions withTransactionSource(Optional<? extends TransactionSource> transactionSource) {
        Utils.checkNotNull(transactionSource, "transactionSource");
        this.transactionSource = transactionSource;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CardPaymentOptions other = (CardPaymentOptions) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CardPaymentOptions.class,
    ...
    public final static class Builder {
        ...
        public CardPaymentOptions build() {

            return new CardPaymentOptions(
                dynamicDescriptor, transactionSource);
        }
