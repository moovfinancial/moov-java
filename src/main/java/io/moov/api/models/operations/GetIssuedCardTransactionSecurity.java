...
public class GetIssuedCardTransactionSecurity {
    ...
    @JsonCreator
    public GetIssuedCardTransactionSecurity(
    ...
    public GetIssuedCardTransactionSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetIssuedCardTransactionSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetIssuedCardTransactionSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetIssuedCardTransactionSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetIssuedCardTransactionSecurity other = (GetIssuedCardTransactionSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetIssuedCardTransactionSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetIssuedCardTransactionSecurity build() {
            return new GetIssuedCardTransactionSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
