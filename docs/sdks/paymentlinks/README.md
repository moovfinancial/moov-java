        ...
        CreatePaymentLinkResponse res = sdk.paymentLinks().create()
                ...
                .createPaymentLink(CreatePaymentLink.builder()
                    ...
                    .display(PaymentLinkDisplayOptions.builder()
                        ...
                        .callToAction(CallToAction.DONATE)
                        .build())
                    .customer(PaymentLinkCustomerOptions.builder()
                        .requirePhone(true)
                        .build())
                    .customAmountPayment(PaymentLinkCustomAmountPaymentDetails.builder()
                        .allowedMethods(List.of(
                            CollectionPaymentMethodType.CARD_PAYMENT,
                            CollectionPaymentMethodType.ACH_DEBIT_COLLECT))
                        .amountRange(AmountDecimalRange.builder()
                            .minimum(AmountDecimal.builder()
                                .currency("USD")
                                .valueDecimal("0.00")
                                .build())
                            .maximum(AmountDecimal.builder()
                                .currency("USD")
...
| `accountID`                                                                                                                                                                                  | *String*                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                           | The merchant account ID.                                                                                                                                                                     |                                                                                                                                                                                              |
| `paymentLinkCode`                                                                                                                                                                            | *String*                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                           | N/A                                                                                                                                                                                          | uc7ZYKrMhi                                                                                                                                                                                   |
| `updatePaymentLink`                                                                                                                                                                          | [UpdatePaymentLink](../../models/components/UpdatePaymentLink.md)                                                                                                                            | :heavy_check_mark:                                                                                                                                                                           | N/A                                                                                                                                                                                          | {<br/>"amount": {<br/>"currency": "USD",<br/>"value": 12099<br/>},<br/>"amountDetails": {<br/>"tax": {<br/>"currency": "USD",<br/>"valueDecimal": "9.25"<br/>}<br/>},<br/>"customer": {<br/>"requirePhone": true,<br/>"requireAddress": true<br/>}<br/>} |
