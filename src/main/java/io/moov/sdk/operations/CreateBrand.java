...
public class CreateBrand {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateBrandRequest, CreateBrandResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(CreateBrandRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBrandRequest.class, new TypeReference<CreateBrandRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBrandRequest request) throws Exception {
        ...
        @Override
        public CreateBrandResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBrandResponse.Builder resBuilder =
                    CreateBrandResponse
                            .builder()
            ...
            CreateBrandResponse res = resBuilder.build();
