...
public class GetTerminalApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTerminalApplicationRequest, GetTerminalApplicationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTerminalApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTerminalApplicationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTerminalApplicationRequest request) {
        ...
        @Override
        public GetTerminalApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTerminalApplicationResponse.Builder resBuilder =
            ...
            GetTerminalApplicationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTerminalApplication(Utils.unmarshal(response, new TypeReference<TerminalApplication>() {}));
                } else {
