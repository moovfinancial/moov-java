...
public class ListPaymentLinksOperation implements RequestOperation<ListPaymentLinksRequest, ListPaymentLinksResponse> {
    ...
    public ListPaymentLinksOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPaymentLinksRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListPaymentLinksRequest request) throws Exception {
    ...
    @Override
    public ListPaymentLinksResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            ...
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<PaymentLink> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
