...
public class AssignAccountCountriesSecurity {
    ...
    @JsonCreator
    public AssignAccountCountriesSecurity(
    ...
    public AssignAccountCountriesSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public AssignAccountCountriesSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public AssignAccountCountriesSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public AssignAccountCountriesSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssignAccountCountriesSecurity other = (AssignAccountCountriesSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AssignAccountCountriesSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public AssignAccountCountriesSecurity build() {
            return new AssignAccountCountriesSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
