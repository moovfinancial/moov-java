...
public class CreateIndividualErrorItin {
    ...
    @JsonCreator
    public CreateIndividualErrorItin(
    ...
    public CreateIndividualErrorItin withFull(String full) {
        Utils.checkNotNull(full, "full");
        this.full = Optional.ofNullable(full);
        return this;
    }

    public CreateIndividualErrorItin withFull(Optional<String> full) {
        Utils.checkNotNull(full, "full");
        this.full = full;
        return this;
    }

    public CreateIndividualErrorItin withLastFour(String lastFour) {
        Utils.checkNotNull(lastFour, "lastFour");
        this.lastFour = Optional.ofNullable(lastFour);
        return this;
    }

    public CreateIndividualErrorItin withLastFour(Optional<String> lastFour) {
        Utils.checkNotNull(lastFour, "lastFour");
        this.lastFour = lastFour;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateIndividualErrorItin other = (CreateIndividualErrorItin) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateIndividualErrorItin.class,
                "full", full,
                "lastFour", lastFour);
    }
    ...
    public final static class Builder {
        ...
        public CreateIndividualErrorItin build() {
            return new CreateIndividualErrorItin(
                full,
                lastFour);
        }
    }
