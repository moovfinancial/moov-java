...
public class DisableWebhook {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableWebhookRequest, DisableWebhookResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DisableWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableWebhookRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisableWebhookRequest request) {
        ...
        @Override
        public DisableWebhookResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisableWebhookResponse.Builder resBuilder =
            ...
            DisableWebhookResponse res = resBuilder.build();
