...
public class GetScheduledOccurrenceSecurity {
    ...
    @JsonCreator
    public GetScheduledOccurrenceSecurity(
    ...
    public GetScheduledOccurrenceSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetScheduledOccurrenceSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetScheduledOccurrenceSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetScheduledOccurrenceSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetScheduledOccurrenceSecurity other = (GetScheduledOccurrenceSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetScheduledOccurrenceSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetScheduledOccurrenceSecurity build() {
            return new GetScheduledOccurrenceSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
