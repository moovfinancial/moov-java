...
public class DisableCapabilitySecurity {
    ...
    @JsonCreator
    public DisableCapabilitySecurity(
    ...
    public DisableCapabilitySecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public DisableCapabilitySecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public DisableCapabilitySecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public DisableCapabilitySecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DisableCapabilitySecurity other = (DisableCapabilitySecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DisableCapabilitySecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public DisableCapabilitySecurity build() {
            return new DisableCapabilitySecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
