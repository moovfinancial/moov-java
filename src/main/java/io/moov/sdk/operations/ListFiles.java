...
public class ListFiles {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFilesRequest request) {
        ...
        @Override
        public ListFilesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFileDetails(Utils.unmarshal(response, new TypeReference<List<FileDetails>>() {}));
                } else {
