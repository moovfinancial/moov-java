...
public class GetUnderwritingOperation implements RequestOperation<GetUnderwritingRequest, GetUnderwritingResponse> {
    ...
    public GetUnderwritingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUnderwritingRequest request) throws Exception {
