...
public class GetAdjustmentOperation implements RequestOperation<GetAdjustmentRequest, GetAdjustmentResponse> {
    ...
    public GetAdjustmentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAdjustmentRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetAdjustmentRequest request) throws Exception {
    ...
    @Override
    public GetAdjustmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetAdjustmentResponse.Builder resBuilder = 
        ...
        GetAdjustmentResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                Adjustment out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withAdjustment(out);
                return res;
            } else {
