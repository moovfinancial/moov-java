...
public class GetMerchantProcessingAgreementResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public GetMerchantProcessingAgreementResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMerchantProcessingAgreementResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMerchantProcessingAgreementResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The request has succeeded.
     */
    public GetMerchantProcessingAgreementResponse withResponseStream(InputStream responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
     ...
     * The request has succeeded.
     */
    public GetMerchantProcessingAgreementResponse withResponseStream(Optional<? extends InputStream> responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
        this.responseStream = responseStream;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMerchantProcessingAgreementResponse other = (GetMerchantProcessingAgreementResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMerchantProcessingAgreementResponse.class,
