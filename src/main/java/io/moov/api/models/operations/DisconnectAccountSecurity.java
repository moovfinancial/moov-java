...
public class DisconnectAccountSecurity {
    ...
    @JsonCreator
    public DisconnectAccountSecurity(
    ...
    public DisconnectAccountSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public DisconnectAccountSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public DisconnectAccountSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public DisconnectAccountSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DisconnectAccountSecurity other = (DisconnectAccountSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DisconnectAccountSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public DisconnectAccountSecurity build() {
            return new DisconnectAccountSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
