...
public class GetSweepOperation implements RequestOperation<GetSweepRequest, GetSweepResponse> {
    ...
    public GetSweepOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetSweepRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetSweepRequest request) throws Exception {
    ...
    @Override
    public GetSweepResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetSweepResponse.Builder resBuilder = 
            GetSweepResponse
                .builder()
        ...
        GetSweepResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                Sweep out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withSweep(out);
