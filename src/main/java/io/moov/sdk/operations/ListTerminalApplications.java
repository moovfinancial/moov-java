...
public class ListTerminalApplications {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTerminalApplicationsRequest request) {
        ...
        @Override
        public ListTerminalApplicationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTerminalApplications(Utils.unmarshal(response, new TypeReference<List<TerminalApplication>>() {}));
                } else {
