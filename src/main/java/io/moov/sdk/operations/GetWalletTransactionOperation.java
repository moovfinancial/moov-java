...
public class GetWalletTransactionOperation implements RequestOperation<GetWalletTransactionRequest, GetWalletTransactionResponse> {
    ...
    public GetWalletTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetWalletTransactionRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetWalletTransactionRequest request) throws Exception {
    ...
    @Override
    public GetWalletTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetWalletTransactionResponse.Builder resBuilder = 
        ...
        GetWalletTransactionResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                WalletTransaction out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withWalletTransaction(out);
                return res;
            } else {
