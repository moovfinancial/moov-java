...
public class ListPartnerPricingAgreementsRequest {
     ...
     * Specify an API version.
     */
    public ListPartnerPricingAgreementsRequest withXMoovVersion(Versions xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
     ...
     * Specify an API version.
     */
    public ListPartnerPricingAgreementsRequest withXMoovVersion(Optional<? extends Versions> xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
        this.xMoovVersion = xMoovVersion;
        return this;
    }
