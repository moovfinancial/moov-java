...
public class ListConnectedAccountsForAccount {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listConnectedAccountsForAccount",
    ...
    public static class Sync extends Base
            implements RequestOperation<ListConnectedAccountsForAccountRequest, ListConnectedAccountsForAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListConnectedAccountsForAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListConnectedAccountsForAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListConnectedAccountsForAccountRequest request) {
        ...
        @Override
        public ListConnectedAccountsForAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListConnectedAccountsForAccountResponse.Builder resBuilder =
            ...
            ListConnectedAccountsForAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccounts(Utils.unmarshal(response, new TypeReference<List<Account>>() {}));
                } else {
