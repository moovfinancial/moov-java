...
public class CreateResolutionLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateResolutionLinkRequest, CreateResolutionLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateResolutionLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateResolutionLinkRequest.class, new TypeReference<CreateResolutionLinkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateResolutionLinkRequest request) {
        ...
        @Override
        public CreateResolutionLinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateResolutionLinkResponse.Builder resBuilder =
            ...
            CreateResolutionLinkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResolutionLink(Utils.unmarshal(response, new TypeReference<ResolutionLink>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CreateResolutionLinkError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
