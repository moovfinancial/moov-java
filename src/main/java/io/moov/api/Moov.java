...
import io.moov.api.utils.SpeakeasyHTTPClient;
...
public class Moov {
    ...
    public static class Builder {
         ...
         * @return The builder instance.
         */
        public Builder security(io.moov.api.models.components.Security security) {
        ...
        Builder _hooks(io.moov.api.utils.Hooks hooks) {
            sdkConfiguration.setHooks(hooks);  
            return this;  
        }
        
        // Visible for testing, may be accessed via reflection in tests
        Builder _hooks(Consumer<? super io.moov.api.utils.Hooks> consumer) {
