...
public class GetBankAccountOperation implements RequestOperation<GetBankAccountRequest, GetBankAccountResponse> {
    ...
    public GetBankAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetBankAccountRequest request) throws Exception {
