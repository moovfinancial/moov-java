...
public class CollectionPaymentMethodType {
    ...
    public static final CollectionPaymentMethodType GOOGLE_PAY = new CollectionPaymentMethodType("google-pay");
    ...
    private static final Map<String, CollectionPaymentMethodTypeEnum> createEnumsMap() {
        ...
        map.put("google-pay", CollectionPaymentMethodTypeEnum.GOOGLE_PAY);
        return map;
    }
