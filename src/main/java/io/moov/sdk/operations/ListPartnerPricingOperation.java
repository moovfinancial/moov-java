...
public class ListPartnerPricingOperation implements RequestOperation<ListPartnerPricingRequest, ListPartnerPricingResponse> {
    ...
    public ListPartnerPricingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPartnerPricingRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListPartnerPricingRequest request) throws Exception {
    ...
    @Override
    public ListPartnerPricingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListPartnerPricingResponse.Builder resBuilder = 
        ...
        ListPartnerPricingResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<PartnerPricing> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withPartnerPricings(out);
                return res;
            } else {
