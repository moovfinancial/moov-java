...
public class SubmitDisputeEvidenceOperation implements RequestOperation<SubmitDisputeEvidenceRequest, SubmitDisputeEvidenceResponse> {
    ...
    public SubmitDisputeEvidenceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(SubmitDisputeEvidenceRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(SubmitDisputeEvidenceRequest request) throws Exception {
    ...
    @Override
    public SubmitDisputeEvidenceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        SubmitDisputeEvidenceResponse.Builder resBuilder = 
        ...
        SubmitDisputeEvidenceResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                Dispute out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withDispute(out);
