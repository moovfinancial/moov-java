...
public class ListPartnerPricingAgreementsSecurity {
    ...
    @JsonCreator
    public ListPartnerPricingAgreementsSecurity(
    ...
    public ListPartnerPricingAgreementsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListPartnerPricingAgreementsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListPartnerPricingAgreementsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListPartnerPricingAgreementsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPartnerPricingAgreementsSecurity other = (ListPartnerPricingAgreementsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPartnerPricingAgreementsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListPartnerPricingAgreementsSecurity build() {
            return new ListPartnerPricingAgreementsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
