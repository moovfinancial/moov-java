...
public class CreateOnboardingInviteOperation implements RequestOperation<OnboardingInviteRequest, CreateOnboardingInviteResponse> {
    ...
    public CreateOnboardingInviteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(OnboardingInviteRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OnboardingInviteRequest request) throws Exception {
    ...
    @Override
    public CreateOnboardingInviteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreateOnboardingInviteResponse.Builder resBuilder = 
        ...
        CreateOnboardingInviteResponse res = resBuilder.build();
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                OnboardingInviteError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
