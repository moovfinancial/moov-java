...
public class UpdatePaymentLinkOperation implements RequestOperation<UpdatePaymentLinkRequest, UpdatePaymentLinkResponse> {
    ...
    public UpdatePaymentLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdatePaymentLinkRequest request) throws Exception {
