...
public class LinkApplePayTokenSecurity {
    ...
    @JsonCreator
    public LinkApplePayTokenSecurity(
    ...
    public LinkApplePayTokenSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public LinkApplePayTokenSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public LinkApplePayTokenSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public LinkApplePayTokenSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LinkApplePayTokenSecurity other = (LinkApplePayTokenSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LinkApplePayTokenSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public LinkApplePayTokenSecurity build() {
            return new LinkApplePayTokenSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
