...
public class CreateTerminalApplicationVersion {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTerminalApplicationVersionRequest, CreateTerminalApplicationVersionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTerminalApplicationVersionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTerminalApplicationVersionRequest.class, new TypeReference<CreateTerminalApplicationVersionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTerminalApplicationVersionRequest request) {
        ...
        @Override
        public CreateTerminalApplicationVersionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTerminalApplicationVersion(Utils.unmarshal(response, new TypeReference<TerminalApplicationVersion>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw TerminalApplicationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
