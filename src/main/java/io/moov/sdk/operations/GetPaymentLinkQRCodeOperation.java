...
public class GetPaymentLinkQRCodeOperation implements RequestOperation<GetPaymentLinkQRCodeRequest, GetPaymentLinkQRCodeResponse> {
    ...
    public GetPaymentLinkQRCodeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetPaymentLinkQRCodeRequest request) throws Exception {
        ...
        req.addHeader("Accept", "application/json;q=1, image/png;q=0")
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetPaymentLinkQRCodeRequest request) throws Exception {
    ...
    @Override
    public GetPaymentLinkQRCodeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetPaymentLinkQRCodeResponse.Builder resBuilder = 
        ...
        GetPaymentLinkQRCodeResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                QRCode out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withQRCode(out);
