...
public class CompleteBankAccountVerification {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CompleteBankAccountVerificationRequest request) {
        ...
        @Override
        public CompleteBankAccountVerificationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBankAccountVerification(Utils.unmarshal(response, new TypeReference<BankAccountVerification>() {}));
                } else {
