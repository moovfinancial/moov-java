...
public class ListIssuedCardAuthorizations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListIssuedCardAuthorizationsRequest request) {
        ...
        @Override
        public ListIssuedCardAuthorizationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIssuedCardAuthorizations(Utils.unmarshal(response, new TypeReference<List<IssuedCardAuthorization>>() {}));
                } else {
