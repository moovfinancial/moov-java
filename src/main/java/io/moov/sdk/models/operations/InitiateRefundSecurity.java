...
public class InitiateRefundSecurity {
    ...
    public InitiateRefundSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public InitiateRefundSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public InitiateRefundSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public InitiateRefundSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InitiateRefundSecurity other = (InitiateRefundSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InitiateRefundSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public InitiateRefundSecurity build() {
            return new InitiateRefundSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
