...
public class UpdateRepresentativeAddress {
    ...
    @JsonCreator
    public UpdateRepresentativeAddress(
    ...
    public UpdateRepresentativeAddress withAddressLine1(String addressLine1) {
        Utils.checkNotNull(addressLine1, "addressLine1");
        this.addressLine1 = Optional.ofNullable(addressLine1);
        return this;
    }

    public UpdateRepresentativeAddress withAddressLine1(Optional<String> addressLine1) {
        Utils.checkNotNull(addressLine1, "addressLine1");
        this.addressLine1 = addressLine1;
        return this;
    }

    public UpdateRepresentativeAddress withAddressLine2(String addressLine2) {
        Utils.checkNotNull(addressLine2, "addressLine2");
        this.addressLine2 = Optional.ofNullable(addressLine2);
        return this;
    }

    public UpdateRepresentativeAddress withAddressLine2(Optional<String> addressLine2) {
        Utils.checkNotNull(addressLine2, "addressLine2");
        this.addressLine2 = addressLine2;
        return this;
    }

    public UpdateRepresentativeAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = Optional.ofNullable(city);
        return this;
    }

    public UpdateRepresentativeAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public UpdateRepresentativeAddress withStateOrProvince(String stateOrProvince) {
        Utils.checkNotNull(stateOrProvince, "stateOrProvince");
        this.stateOrProvince = Optional.ofNullable(stateOrProvince);
        return this;
    }

    public UpdateRepresentativeAddress withStateOrProvince(Optional<String> stateOrProvince) {
        Utils.checkNotNull(stateOrProvince, "stateOrProvince");
        this.stateOrProvince = stateOrProvince;
        return this;
    }

    public UpdateRepresentativeAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = Optional.ofNullable(postalCode);
        return this;
    }

    public UpdateRepresentativeAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public UpdateRepresentativeAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = Optional.ofNullable(country);
        return this;
    }

    public UpdateRepresentativeAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateRepresentativeAddress other = (UpdateRepresentativeAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateRepresentativeAddress.class,
    ...
    public final static class Builder {
        ...
        public UpdateRepresentativeAddress build() {
            return new UpdateRepresentativeAddress(
                addressLine1,
                addressLine2,
                city,
                stateOrProvince,
