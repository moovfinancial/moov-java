...
public class UpdateBrand {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateBrandRequest, UpdateBrandResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateBrandRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateBrandRequest.class, new TypeReference<UpdateBrandRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBrandRequest request) throws Exception {
        ...
        @Override
        public UpdateBrandResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateBrandResponse.Builder resBuilder =
                    UpdateBrandResponse
                            .builder()
            ...
            UpdateBrandResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BrandProperties out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBrandProperties(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BrandValidationError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
