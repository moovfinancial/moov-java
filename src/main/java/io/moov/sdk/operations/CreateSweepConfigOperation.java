...
public class CreateSweepConfigOperation implements RequestOperation<CreateSweepConfigRequest, CreateSweepConfigResponse> {
    ...
    public CreateSweepConfigOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateSweepConfigRequest request) throws Exception {
