...
public class GetDisputeEvidenceOperation implements RequestOperation<GetDisputeEvidenceRequest, GetDisputeEvidenceResponse> {
    ...
    public GetDisputeEvidenceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetDisputeEvidenceRequest request) throws Exception {
