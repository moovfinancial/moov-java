...
public class TransferTerminalCard {
    ...
    @JsonCreator
    public TransferTerminalCard(
            @JsonProperty("entryMode") Optional<? extends TransferEntryMode> entryMode,
    ...
    @JsonIgnore
    public Optional<TransferEntryMode> entryMode() {
        return (Optional<TransferEntryMode>) entryMode;
    }
     ...
     * How the card information was entered into the point of sale terminal.
     */
    public TransferTerminalCard withEntryMode(TransferEntryMode entryMode) {
        Utils.checkNotNull(entryMode, "entryMode");
     ...
     * How the card information was entered into the point of sale terminal.
     */
    public TransferTerminalCard withEntryMode(Optional<? extends TransferEntryMode> entryMode) {
        Utils.checkNotNull(entryMode, "entryMode");
        this.entryMode = entryMode;
        return this;
    }
     ...
     * The card brand.
     */
    public TransferTerminalCard withBrand(CardBrand brand) {
        Utils.checkNotNull(brand, "brand");
     ...
     * The card brand.
     */
    public TransferTerminalCard withBrand(Optional<? extends CardBrand> brand) {
        Utils.checkNotNull(brand, "brand");
        this.brand = brand;
        return this;
    }

    public TransferTerminalCard withBin(String bin) {
        Utils.checkNotNull(bin, "bin");
    ...
    public TransferTerminalCard withBin(Optional<String> bin) {
        Utils.checkNotNull(bin, "bin");
        this.bin = bin;
        return this;
    }
     ...
     * The type of the card.
     */
    public TransferTerminalCard withCardType(CardType cardType) {
        Utils.checkNotNull(cardType, "cardType");
     ...
     * The type of the card.
     */
    public TransferTerminalCard withCardType(Optional<? extends CardType> cardType) {
        Utils.checkNotNull(cardType, "cardType");
        this.cardType = cardType;
        return this;
    }
     ...
     * The expiration date of the card or token.
     */
    public TransferTerminalCard withExpiration(CardExpiration expiration) {
        Utils.checkNotNull(expiration, "expiration");
     ...
     * The expiration date of the card or token.
     */
    public TransferTerminalCard withExpiration(Optional<? extends CardExpiration> expiration) {
        Utils.checkNotNull(expiration, "expiration");
        this.expiration = expiration;
        return this;
    }
     ...
     * platform.
     */
    public TransferTerminalCard withFingerprint(String fingerprint) {
        Utils.checkNotNull(fingerprint, "fingerprint");
     ...
     * platform.
     */
    public TransferTerminalCard withFingerprint(Optional<String> fingerprint) {
        Utils.checkNotNull(fingerprint, "fingerprint");
        this.fingerprint = fingerprint;
        return this;
    }
     ...
     * The name of the cardholder as it appears on the card.
     */
    public TransferTerminalCard withHolderName(String holderName) {
        Utils.checkNotNull(holderName, "holderName");
     ...
     * The name of the cardholder as it appears on the card.
     */
    public TransferTerminalCard withHolderName(Optional<String> holderName) {
        Utils.checkNotNull(holderName, "holderName");
        this.holderName = holderName;
        return this;
    }
     ...
     * Financial institution that issued the card.
     */
    public TransferTerminalCard withIssuer(String issuer) {
        Utils.checkNotNull(issuer, "issuer");
     ...
     * Financial institution that issued the card.
     */
    public TransferTerminalCard withIssuer(Optional<String> issuer) {
        Utils.checkNotNull(issuer, "issuer");
        this.issuer = issuer;
        return this;
    }
     ...
     * Country where the card was issued.
     */
    public TransferTerminalCard withIssuerCountry(String issuerCountry) {
        Utils.checkNotNull(issuerCountry, "issuerCountry");
     ...
     * Country where the card was issued.
     */
    public TransferTerminalCard withIssuerCountry(Optional<String> issuerCountry) {
        Utils.checkNotNull(issuerCountry, "issuerCountry");
        this.issuerCountry = issuerCountry;
        return this;
    }
     ...
     * Last four digits of the card number
     */
    public TransferTerminalCard withLastFourCardNumber(String lastFourCardNumber) {
        Utils.checkNotNull(lastFourCardNumber, "lastFourCardNumber");
     ...
     * Last four digits of the card number
     */
    public TransferTerminalCard withLastFourCardNumber(Optional<String> lastFourCardNumber) {
        Utils.checkNotNull(lastFourCardNumber, "lastFourCardNumber");
        this.lastFourCardNumber = lastFourCardNumber;
        return this;
    }
     ...
     * Identifier for the point of sale terminal application.
     */
    public TransferTerminalCard withApplicationID(String applicationID) {
        Utils.checkNotNull(applicationID, "applicationID");
     ...
     * Identifier for the point of sale terminal application.
     */
    public TransferTerminalCard withApplicationID(Optional<String> applicationID) {
        Utils.checkNotNull(applicationID, "applicationID");
        this.applicationID = applicationID;
        return this;
    }
     ...
     * Name label for the point of sale terminal application.
     */
    public TransferTerminalCard withApplicationName(String applicationName) {
        Utils.checkNotNull(applicationName, "applicationName");
     ...
     * Name label for the point of sale terminal application.
     */
    public TransferTerminalCard withApplicationName(Optional<String> applicationName) {
        Utils.checkNotNull(applicationName, "applicationName");
        this.applicationName = applicationName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransferTerminalCard other = (TransferTerminalCard) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransferTerminalCard.class,
                "entryMode", entryMode,
                "brand", brand,
                "bin", bin,
                "cardType", cardType,
    ...
    public final static class Builder {
        ...
        private Optional<? extends TransferEntryMode> entryMode = Optional.empty();
         ...
         * How the card information was entered into the point of sale terminal.
         */
        public Builder entryMode(TransferEntryMode entryMode) {
            Utils.checkNotNull(entryMode, "entryMode");
            this.entryMode = Optional.ofNullable(entryMode);
            return this;
        }
         ...
         * How the card information was entered into the point of sale terminal.
         */
        public Builder entryMode(Optional<? extends TransferEntryMode> entryMode) {
            Utils.checkNotNull(entryMode, "entryMode");
            this.entryMode = entryMode;
            return this;
        }
        ...
        public TransferTerminalCard build() {

            return new TransferTerminalCard(
                entryMode, brand, bin,
                cardType, expiration, fingerprint,
                holderName, issuer, issuerCountry,
                lastFourCardNumber, applicationID, applicationName);
