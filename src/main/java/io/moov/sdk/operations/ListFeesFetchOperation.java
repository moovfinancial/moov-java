...
import io.moov.sdk.models.operations.ListFeesFetchRequest;
...
public class ListFeesFetchOperation implements RequestOperation<ListFeesFetchRequest, ListFeesFetchResponse> {
    ...
    public ListFeesFetchOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListFeesFetchRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListFeesFetchRequest request) throws Exception {
    ...
    @Override
    public ListFeesFetchResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListFeesFetchResponse.Builder resBuilder = 
        ...
        ListFeesFetchResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<IncurredFee> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withIncurredFees(out);
                return res;
            } else {
