...
public class CreateAccount {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(io.moov.sdk.models.components.CreateAccount request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<io.moov.sdk.models.components.CreateAccount>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(io.moov.sdk.models.components.CreateAccount request) {
        ...
        public CreateAccountResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CreateAccountError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
