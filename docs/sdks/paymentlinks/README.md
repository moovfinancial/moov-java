...
<!-- UsageSnippet language="java" operationID="createPaymentLink" method="post" path="/accounts/{accountID}/payment-links" -->
```java
package hello.world;
        ...
        CreatePaymentLinkResponse res = sdk.paymentLinks().create()
                ...
                .createPaymentLink(CreatePaymentLink.builder()
                    ...
                    .display(PaymentLinkDisplayOptions.builder()
                        ...
                        .callToAction(CallToAction.CONFIRM)
                        .build())
                    ...
                    .payout(PaymentLinkPayoutDetails.builder()
                        .allowedMethods(List.of(
                            ...
                            DisbursementPaymentMethodType.PUSH_TO_APPLE_PAY,
                            DisbursementPaymentMethodType.RTP_CREDIT,
                            DisbursementPaymentMethodType.ACH_CREDIT_STANDARD))
                        .recipient(PayoutRecipient.builder()
                            .email("jordan@example.com")
                            .build())
                        .pushOptions(PushOptions.builder()
                            .allowedSpeeds(List.of(
                                PushDeliverySpeed.INSTANT,
                                PushDeliverySpeed.DEFERRED))
                            .deferredBy("24h")
                            .build())
                        .feePaidBy(Map.ofEntries(
                            Map.entry("instant-push-to-card", FeePaidBy.DESTINATION),
                            Map.entry("deferred-push-to-card", FeePaidBy.SOURCE),
                            Map.entry("instant-push-to-apple-pay", FeePaidBy.DESTINATION),
                            Map.entry("rtp-credit", FeePaidBy.DESTINATION)))
                        .build())
                    .build())
                .call();
...
<!-- UsageSnippet language="java" operationID="listPaymentLinks" method="get" path="/accounts/{accountID}/payment-links" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="getPaymentLink" method="get" path="/accounts/{accountID}/payment-links/{paymentLinkCode}" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="updatePaymentLink" method="patch" path="/accounts/{accountID}/payment-links/{paymentLinkCode}" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="disablePaymentLink" method="delete" path="/accounts/{accountID}/payment-links/{paymentLinkCode}" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="getPaymentLinkQRCode" method="get" path="/accounts/{accountID}/payment-links/{paymentLinkCode}/qrcode" -->
```java
package hello.world;
