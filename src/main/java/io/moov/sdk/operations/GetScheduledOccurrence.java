...
public class GetScheduledOccurrence {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetScheduledOccurrenceRequest request) {
        ...
        @Override
        public GetScheduledOccurrenceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOccurrencesResponse(Utils.unmarshal(response, new TypeReference<OccurrencesResponse>() {}));
                } else {
