...
public class GetDispute {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetDisputeRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDisputeRequest, GetDisputeResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetDisputeRequest request) throws Exception {
