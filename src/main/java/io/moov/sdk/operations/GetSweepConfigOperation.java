...
public class GetSweepConfigOperation implements RequestOperation<GetSweepConfigRequest, GetSweepConfigResponse> {
    ...
    public GetSweepConfigOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetSweepConfigRequest request) throws Exception {
