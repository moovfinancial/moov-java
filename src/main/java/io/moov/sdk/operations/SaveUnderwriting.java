...
public class SaveUnderwriting {
    ...
    public static class Sync extends Base
            implements RequestOperation<SaveUnderwritingRequest, SaveUnderwritingResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SaveUnderwritingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SaveUnderwritingRequest.class, new TypeReference<SaveUnderwritingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SaveUnderwritingRequest request) throws Exception {
        ...
        @Override
        public SaveUnderwritingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SaveUnderwritingResponse.Builder resBuilder =
            ...
            SaveUnderwritingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Underwriting out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUnderwriting(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpsertUnderwritingError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
