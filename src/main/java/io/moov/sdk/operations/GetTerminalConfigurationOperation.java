...
public class GetTerminalConfigurationOperation implements RequestOperation<GetTerminalConfigurationRequest, GetTerminalConfigurationResponse> {
    ...
    public GetTerminalConfigurationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTerminalConfigurationRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetTerminalConfigurationRequest request) throws Exception {
    ...
    @Override
    public GetTerminalConfigurationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetTerminalConfigurationResponse.Builder resBuilder = 
        ...
        GetTerminalConfigurationResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                TerminalConfiguration out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withTerminalConfiguration(out);
                return res;
            } else {
