...
public class UpdateSweepConfigOperation implements RequestOperation<UpdateSweepConfigRequest, UpdateSweepConfigResponse> {
    ...
    public UpdateSweepConfigOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateSweepConfigRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(UpdateSweepConfigRequest request) throws Exception {
    ...
    @Override
    public UpdateSweepConfigResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        UpdateSweepConfigResponse.Builder resBuilder = 
        ...
        UpdateSweepConfigResponse res = resBuilder.build();
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                PatchSweepConfigError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
