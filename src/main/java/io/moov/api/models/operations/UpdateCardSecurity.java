...
public class UpdateCardSecurity {
    ...
    public UpdateCardSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdateCardSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdateCardSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdateCardSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCardSecurity other = (UpdateCardSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateCardSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdateCardSecurity build() {
            return new UpdateCardSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
