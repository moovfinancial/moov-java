...
public class GetAccountCountriesSecurity {
    ...
    @JsonCreator
    public GetAccountCountriesSecurity(
    ...
    public GetAccountCountriesSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetAccountCountriesSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetAccountCountriesSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetAccountCountriesSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAccountCountriesSecurity other = (GetAccountCountriesSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAccountCountriesSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetAccountCountriesSecurity build() {
            return new GetAccountCountriesSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
