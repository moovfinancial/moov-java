...
public class UpdateSchedule {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateScheduleRequest, UpdateScheduleResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(UpdateScheduleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateScheduleRequest.class, new TypeReference<UpdateScheduleRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateScheduleRequest request) throws Exception {
        ...
        @Override
        public UpdateScheduleResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateScheduleResponse.Builder resBuilder =
            ...
            UpdateScheduleResponse res = resBuilder.build();
