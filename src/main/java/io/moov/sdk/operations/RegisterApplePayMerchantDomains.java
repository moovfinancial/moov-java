...
public class RegisterApplePayMerchantDomains {
    ...
    public static class Sync extends Base
            implements RequestOperation<RegisterApplePayMerchantDomainsRequest, RegisterApplePayMerchantDomainsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RegisterApplePayMerchantDomainsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RegisterApplePayMerchantDomainsRequest.class, new TypeReference<RegisterApplePayMerchantDomainsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RegisterApplePayMerchantDomainsRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "409", "417", "429", "4XX", "500", "504", "5XX")) {
        ...
        @Override
        public RegisterApplePayMerchantDomainsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RegisterApplePayMerchantDomainsResponse.Builder resBuilder =
            ...
            RegisterApplePayMerchantDomainsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ApplePayMerchantDomains out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withApplePayMerchantDomains(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "409", "417", "429")) {
                res.withHeaders(response.headers().map());
                // no content
                throw new APIException(
                        response,
