...
public class DeleteTerminalApplicationOperation implements RequestOperation<DeleteTerminalApplicationRequest, DeleteTerminalApplicationResponse> {
    ...
    public DeleteTerminalApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteTerminalApplicationRequest request) throws Exception {
