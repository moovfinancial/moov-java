...
public class MoneyTransferPushToCard {
    ...
    @JsonCreator
    public MoneyTransferPushToCard(
    ...
    public MoneyTransferPushToCard withEstimatedActivity(EstimatedActivity estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
        this.estimatedActivity = Optional.ofNullable(estimatedActivity);
        return this;
    }

    public MoneyTransferPushToCard withEstimatedActivity(Optional<? extends EstimatedActivity> estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
        this.estimatedActivity = estimatedActivity;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MoneyTransferPushToCard other = (MoneyTransferPushToCard) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MoneyTransferPushToCard.class,
    ...
    public final static class Builder {
        ...
        public MoneyTransferPushToCard build() {
            return new MoneyTransferPushToCard(
                estimatedActivity);
        }
    }
}
