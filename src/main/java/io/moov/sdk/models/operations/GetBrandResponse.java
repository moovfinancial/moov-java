...
public class GetBrandResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetBrandResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetBrandResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetBrandResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The request completed successfully.
     */
    public GetBrandResponse withBrandProperties(BrandProperties brandProperties) {
        Utils.checkNotNull(brandProperties, "brandProperties");
     ...
     * The request completed successfully.
     */
    public GetBrandResponse withBrandProperties(Optional<? extends BrandProperties> brandProperties) {
        Utils.checkNotNull(brandProperties, "brandProperties");
        this.brandProperties = brandProperties;
        return this;
    }

    public GetBrandResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            brandProperties, headers);
    }
    
    @Override
    public String toString() {
        return Utils.toString(GetBrandResponse.class,
