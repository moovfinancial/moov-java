...
public class GetMerchantProcessingAgreementOperation implements RequestOperation<GetMerchantProcessingAgreementRequest, GetMerchantProcessingAgreementResponse> {
    ...
    public GetMerchantProcessingAgreementOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetMerchantProcessingAgreementRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetMerchantProcessingAgreementRequest request) throws Exception {
    ...
    @Override
    public GetMerchantProcessingAgreementResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
