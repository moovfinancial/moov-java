...
public class RequestCapabilitiesOperation implements RequestOperation<RequestCapabilitiesRequest, RequestCapabilitiesResponse> {
    ...
    public RequestCapabilitiesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RequestCapabilitiesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(RequestCapabilitiesRequest request) throws Exception {
    ...
    @Override
    public RequestCapabilitiesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        RequestCapabilitiesResponse.Builder resBuilder = 
        ...
        RequestCapabilitiesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<Capability> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withCapabilities(out);
                return res;
            } else {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AddCapabilitiesError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
