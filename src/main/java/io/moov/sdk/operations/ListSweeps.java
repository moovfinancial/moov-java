...
public class ListSweeps {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListSweepsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSweepsRequest, ListSweepsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListSweepsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSweepsRequest request) throws Exception {
        ...
        @Override
        public ListSweepsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSweepsResponse.Builder resBuilder =
                    ListSweepsResponse
                            .builder()
            ...
            ListSweepsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Sweep> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSweeps(out);
