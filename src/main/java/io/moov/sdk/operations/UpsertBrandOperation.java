...
public class UpsertBrandOperation implements RequestOperation<UpsertBrandRequest, UpsertBrandResponse> {
    ...
    public UpsertBrandOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpsertBrandRequest request) throws Exception {
