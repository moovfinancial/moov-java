...
public class GetAccountTerminalApplicationRequest {
    ...
    public GetAccountTerminalApplicationRequest(
            String accountID,
            String terminalApplicationID) {
        this(Optional.empty(), accountID, terminalApplicationID);
    }
     ...
     * <p>The `latest` version represents the most recent development state. It may include breaking changes and should be treated as a beta release.
     */
    public GetAccountTerminalApplicationRequest withXMoovVersion(String xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
     ...
     * <p>The `latest` version represents the most recent development state. It may include breaking changes and should be treated as a beta release.
     */
    public GetAccountTerminalApplicationRequest withXMoovVersion(Optional<String> xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
        this.xMoovVersion = xMoovVersion;
        return this;
    }
