...
public class ListSweepConfigsOperation implements RequestOperation<ListSweepConfigsRequest, ListSweepConfigsResponse> {
    ...
    public ListSweepConfigsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListSweepConfigsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListSweepConfigsRequest request) throws Exception {
    ...
    @Override
    public ListSweepConfigsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListSweepConfigsResponse.Builder resBuilder = 
        ...
        ListSweepConfigsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<SweepConfig> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withSweepConfigs(out);
                return res;
            } else {
