...
public class IssuingIntervalLimit {
    ...
    public static final IssuingIntervalLimit DAILY = new IssuingIntervalLimit("daily");
    public static final IssuingIntervalLimit WEEKLY = new IssuingIntervalLimit("weekly");
    public static final IssuingIntervalLimit MONTHLY = new IssuingIntervalLimit("monthly");
    ...
    private static final Map<String, IssuingIntervalLimitEnum> createEnumsMap() {
        ...
        map.put("daily", IssuingIntervalLimitEnum.DAILY);
        map.put("weekly", IssuingIntervalLimitEnum.WEEKLY);
        map.put("monthly", IssuingIntervalLimitEnum.MONTHLY);
        return map;
    }
