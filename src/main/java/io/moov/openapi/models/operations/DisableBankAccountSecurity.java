...
public class DisableBankAccountSecurity {
    ...
    @JsonCreator
    public DisableBankAccountSecurity(
    ...
    public DisableBankAccountSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public DisableBankAccountSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public DisableBankAccountSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public DisableBankAccountSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DisableBankAccountSecurity other = (DisableBankAccountSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DisableBankAccountSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public DisableBankAccountSecurity build() {
            return new DisableBankAccountSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
