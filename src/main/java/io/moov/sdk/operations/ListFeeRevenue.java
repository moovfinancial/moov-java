...
public class ListFeeRevenue {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFeeRevenueRequest, ListFeeRevenueResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListFeeRevenueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFeeRevenueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFeeRevenueRequest request) {
        ...
        @Override
        public ListFeeRevenueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListFeeRevenueResponse.Builder resBuilder =
            ...
            ListFeeRevenueResponse res = resBuilder.build();
