...
public class RevokeAccessTokenOperation implements RequestOperation<RevokeTokenRequest, RevokeAccessTokenResponse> {
    ...
    public RevokeAccessTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RevokeTokenRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(RevokeTokenRequest request) throws Exception {
    ...
    @Override
    public RevokeAccessTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                RevokeTokenRequestError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
