...
public class AddCapabilitiesSecurity {
    ...
    @JsonCreator
    public AddCapabilitiesSecurity(
    ...
    public AddCapabilitiesSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public AddCapabilitiesSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public AddCapabilitiesSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public AddCapabilitiesSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddCapabilitiesSecurity other = (AddCapabilitiesSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddCapabilitiesSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public AddCapabilitiesSecurity build() {
            return new AddCapabilitiesSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
