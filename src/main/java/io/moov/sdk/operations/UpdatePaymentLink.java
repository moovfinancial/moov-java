...
public class UpdatePaymentLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePaymentLinkRequest, UpdatePaymentLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(UpdatePaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentLinkRequest.class, new TypeReference<UpdatePaymentLinkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentLinkRequest request) throws Exception {
        ...
        @Override
        public UpdatePaymentLinkResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentLinkResponse.Builder resBuilder =
            ...
            UpdatePaymentLinkResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdatePaymentLinkError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
