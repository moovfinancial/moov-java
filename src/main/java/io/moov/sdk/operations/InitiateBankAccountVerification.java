...
public class InitiateBankAccountVerification {
    ...
    public static class Sync extends Base
            implements RequestOperation<InitiateBankAccountVerificationRequest, InitiateBankAccountVerificationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(InitiateBankAccountVerificationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InitiateBankAccountVerificationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InitiateBankAccountVerificationRequest request) {
        ...
        @Override
        public InitiateBankAccountVerificationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBankAccountVerificationCreated(Utils.unmarshal(response, new TypeReference<BankAccountVerificationCreated>() {}));
                } else {
