...
public class ListIssuedCardsOperation implements RequestOperation<ListIssuedCardsRequest, ListIssuedCardsResponse> {
    ...
    public ListIssuedCardsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListIssuedCardsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListIssuedCardsRequest request) throws Exception {
    ...
    @Override
    public ListIssuedCardsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            ...
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<IssuedCard> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withIssuedCards(out);
                return res;
            } else {
