...
public class GetCapture {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCaptureRequest, GetCaptureResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCaptureRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCaptureRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCaptureRequest request) {
        ...
        @Override
        public GetCaptureResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCaptureResponse.Builder resBuilder =
                    GetCaptureResponse
                            .builder()
            ...
            GetCaptureResponse res = resBuilder.build();
