...
public class ListDisputeEvidence {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDisputeEvidenceRequest request) {
        ...
        @Override
        public ListDisputeEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDisputeEvidenceResponses(Utils.unmarshal(response, new TypeReference<List<DisputeEvidenceResponse>>() {}));
                } else {
