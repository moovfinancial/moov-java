...
public class PushToCardOptions {
    /**
     ...
     * enabled by Moov to set this field.
     */
    public PushToCardOptions withDynamicDescriptor(String dynamicDescriptor) {
        Utils.checkNotNull(dynamicDescriptor, "dynamicDescriptor");
     ...
     * enabled by Moov to set this field.
     */
    public PushToCardOptions withDynamicDescriptor(Optional<String> dynamicDescriptor) {
        Utils.checkNotNull(dynamicDescriptor, "dynamicDescriptor");
        this.dynamicDescriptor = dynamicDescriptor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PushToCardOptions other = (PushToCardOptions) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PushToCardOptions.class,
    ...
    public final static class Builder {
        ...
        public PushToCardOptions build() {

            return new PushToCardOptions(
                dynamicDescriptor);
        }
