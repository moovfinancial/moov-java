...
/**
 * End2EndEncryption - Optional and only used if planning to use End to End Encryption to pass PCI data through an intermediary. 
...
public class End2EndEncryption {
    ...
    public End2EndEncryption withToken(String token) {
        Utils.checkNotNull(token, "token");
        this.token = token;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        End2EndEncryption other = (End2EndEncryption) o;
        return 
    ...
    public String toString() {
        return Utils.toString(End2EndEncryption.class,
                "token", token);
    }
    ...
    public final static class Builder {
        ...
        public End2EndEncryption build() {
            return new End2EndEncryption(
                token);
        }
    }
}
