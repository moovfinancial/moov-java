...
public class ListBankAccountsOperation implements RequestOperation<ListBankAccountsRequest, ListBankAccountsResponse> {
    ...
    public ListBankAccountsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListBankAccountsRequest request) throws Exception {
    ...
    public ListBankAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            ...
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<BankAccount> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withBankAccounts(out);
                return res;
            } else {
