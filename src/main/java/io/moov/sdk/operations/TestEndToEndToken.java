...
public class TestEndToEndToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<E2EEToken, TestEndToEndTokenResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(E2EEToken request) {
        ...
        @Override
        public TestEndToEndTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TestEndToEndTokenResponse.Builder resBuilder =
            ...
            TestEndToEndTokenResponse res = resBuilder.build();
