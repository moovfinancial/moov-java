...
public class ListCapabilitiesOperation implements RequestOperation<ListCapabilitiesRequest, ListCapabilitiesResponse> {
    ...
    public ListCapabilitiesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCapabilitiesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListCapabilitiesRequest request) throws Exception {
    ...
    @Override
    public ListCapabilitiesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListCapabilitiesResponse.Builder resBuilder = 
        ...
        ListCapabilitiesResponse res = resBuilder.build();
