...
public class UpdateIssuedCardOperation implements RequestOperation<UpdateIssuedCardRequest, UpdateIssuedCardResponse> {
    ...
    public UpdateIssuedCardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateIssuedCardRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(UpdateIssuedCardRequest request) throws Exception {
    ...
    @Override
    public UpdateIssuedCardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                UpdateIssuedCardError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
