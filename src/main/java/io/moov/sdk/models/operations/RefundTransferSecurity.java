...
public class RefundTransferSecurity {
    ...
    public RefundTransferSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public RefundTransferSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public RefundTransferSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public RefundTransferSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefundTransferSecurity other = (RefundTransferSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RefundTransferSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public RefundTransferSecurity build() {
            return new RefundTransferSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
