...
public class CreateAccessTokenOperation implements RequestOperation<AuthTokenRequest, CreateAccessTokenResponse> {
    ...
    public CreateAccessTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AuthTokenRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenRequest request) throws Exception {
    ...
    @Override
    public CreateAccessTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreateAccessTokenResponse.Builder resBuilder = 
        ...
        CreateAccessTokenResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthToken out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withAuthToken(out);
                return res;
            } else {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenRequestError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
