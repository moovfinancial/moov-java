...
public class MaxPerTransaction {
     ...
     * A 3-letter ISO 4217 currency code.
     */
    public MaxPerTransaction withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * For example, $12.987654321 is '12.987654321'.
     */
    public MaxPerTransaction withValueDecimal(String valueDecimal) {
        Utils.checkNotNull(valueDecimal, "valueDecimal");
        this.valueDecimal = valueDecimal;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MaxPerTransaction other = (MaxPerTransaction) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MaxPerTransaction.class,
                "currency", currency,
    ...
    public final static class Builder {
        ...
        public MaxPerTransaction build() {
            return new MaxPerTransaction(
                currency,
                valueDecimal);
        }
    }
