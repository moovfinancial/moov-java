...
public class UpdateProduct {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateProductRequest, UpdateProductResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateProductRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateProductRequest.class, new TypeReference<UpdateProductRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateProductRequest request) throws Exception {
        ...
        @Override
        public UpdateProductResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateProductResponse.Builder resBuilder =
            ...
            UpdateProductResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Product out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withProduct(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ProductRequestValidationError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
