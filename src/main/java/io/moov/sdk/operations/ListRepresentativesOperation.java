...
public class ListRepresentativesOperation implements RequestOperation<ListRepresentativesRequest, ListRepresentativesResponse> {
    ...
    public ListRepresentativesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListRepresentativesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListRepresentativesRequest request) throws Exception {
    ...
    @Override
    public ListRepresentativesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListRepresentativesResponse.Builder resBuilder = 
        ...
        ListRepresentativesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<Representative> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withRepresentatives(out);
                return res;
            } else {
