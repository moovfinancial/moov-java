...
public class UpdateUnderwritingSecurity {
    ...
    @JsonCreator
    public UpdateUnderwritingSecurity(
    ...
    public UpdateUnderwritingSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdateUnderwritingSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdateUnderwritingSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdateUnderwritingSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateUnderwritingSecurity other = (UpdateUnderwritingSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateUnderwritingSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdateUnderwritingSecurity build() {
            return new UpdateUnderwritingSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
