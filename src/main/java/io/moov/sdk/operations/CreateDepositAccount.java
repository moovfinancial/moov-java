...
public class CreateDepositAccount {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/underwriting/{accountID}/deposit-accounts",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDepositAccountRequest, CreateDepositAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDepositAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDepositAccountRequest.class, new TypeReference<CreateDepositAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDepositAccountRequest request) {
        ...
        @Override
        public CreateDepositAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDepositAccountResponse.Builder resBuilder =
            ...
            CreateDepositAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDepositAccountIngestedResponse(Utils.unmarshal(response, new TypeReference<DepositAccountIngestedResponse>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw DepositAccountValidationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
