...
public class GetWalletTransactionSecurity {
    ...
    @JsonCreator
    public GetWalletTransactionSecurity(
    ...
    public GetWalletTransactionSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetWalletTransactionSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetWalletTransactionSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetWalletTransactionSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetWalletTransactionSecurity other = (GetWalletTransactionSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetWalletTransactionSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetWalletTransactionSecurity build() {
            return new GetWalletTransactionSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
