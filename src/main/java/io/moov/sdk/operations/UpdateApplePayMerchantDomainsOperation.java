...
public class UpdateApplePayMerchantDomainsOperation implements RequestOperation<UpdateApplePayMerchantDomainsRequest, UpdateApplePayMerchantDomainsResponse> {
    ...
    public UpdateApplePayMerchantDomainsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateApplePayMerchantDomainsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(UpdateApplePayMerchantDomainsRequest request) throws Exception {
        HttpRequest r = buildRequest(request);
        HttpResponse<InputStream> httpRes;
        try {
            httpRes = client.send(r);
            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "409", "417", "429", "4XX", "500", "504", "5XX")) {
    ...
    @Override
    public UpdateApplePayMerchantDomainsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        UpdateApplePayMerchantDomainsResponse.Builder resBuilder = 
        ...
        UpdateApplePayMerchantDomainsResponse res = resBuilder.build();
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "404", "409", "417", "429")) {
            res.withHeaders(response.headers().map());
            // no content 
            throw new APIException(
                    response, 
