...
public class ListWalletTransactionsOperation implements RequestOperation<ListWalletTransactionsRequest, ListWalletTransactionsResponse> {
    ...
    public ListWalletTransactionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListWalletTransactionsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListWalletTransactionsRequest request) throws Exception {
    ...
    @Override
    public ListWalletTransactionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            ...
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<WalletTransaction> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withWalletTransactions(out);
                return res;
            } else {
