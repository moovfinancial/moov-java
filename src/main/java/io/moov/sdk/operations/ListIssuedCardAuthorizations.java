...
public class ListIssuedCardAuthorizations {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListIssuedCardAuthorizationsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListIssuedCardAuthorizationsRequest, ListIssuedCardAuthorizationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListIssuedCardAuthorizationsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListIssuedCardAuthorizationsRequest request) throws Exception {
        ...
        @Override
        public ListIssuedCardAuthorizationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListIssuedCardAuthorizationsResponse.Builder resBuilder =
            ...
            ListIssuedCardAuthorizationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<IssuedCardAuthorization> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIssuedCardAuthorizations(out);
                    return res;
                } else {
