...
public class ListSweepsOperation implements RequestOperation<ListSweepsRequest, ListSweepsResponse> {
    ...
    public ListSweepsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListSweepsRequest request) throws Exception {
