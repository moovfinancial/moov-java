...
public class AcceptDisputeSecurity {
    ...
    public AcceptDisputeSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public AcceptDisputeSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public AcceptDisputeSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public AcceptDisputeSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AcceptDisputeSecurity other = (AcceptDisputeSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AcceptDisputeSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public AcceptDisputeSecurity build() {
            return new AcceptDisputeSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
