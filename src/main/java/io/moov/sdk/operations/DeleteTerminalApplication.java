...
public class DeleteTerminalApplication {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteTerminalApplicationRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteTerminalApplicationRequest, DeleteTerminalApplicationResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DeleteTerminalApplicationRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteTerminalApplicationRequest request) throws Exception {
        ...
        @Override
        public DeleteTerminalApplicationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteTerminalApplicationResponse.Builder resBuilder =
            ...
            DeleteTerminalApplicationResponse res = resBuilder.build();
