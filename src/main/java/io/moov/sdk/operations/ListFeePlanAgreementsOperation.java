...
public class ListFeePlanAgreementsOperation implements RequestOperation<ListFeePlanAgreementsRequest, ListFeePlanAgreementsResponse> {
    ...
    public ListFeePlanAgreementsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListFeePlanAgreementsRequest request) throws Exception {
