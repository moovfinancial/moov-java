...
public class GetCancellation {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCancellationRequest request) {
        ...
        @Override
        public GetCancellationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCancellation(Utils.unmarshal(response, new TypeReference<Cancellation>() {}));
                } else {
