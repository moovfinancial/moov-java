...
public class CreateApplePaySessionSecurity {
    ...
    @JsonCreator
    public CreateApplePaySessionSecurity(
    ...
    public CreateApplePaySessionSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CreateApplePaySessionSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CreateApplePaySessionSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CreateApplePaySessionSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateApplePaySessionSecurity other = (CreateApplePaySessionSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateApplePaySessionSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CreateApplePaySessionSecurity build() {
            return new CreateApplePaySessionSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
