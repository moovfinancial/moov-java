...
public class TestEndToEndTokenSecurity {
    ...
    @JsonCreator
    public TestEndToEndTokenSecurity(
    ...
    public TestEndToEndTokenSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public TestEndToEndTokenSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public TestEndToEndTokenSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public TestEndToEndTokenSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TestEndToEndTokenSecurity other = (TestEndToEndTokenSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TestEndToEndTokenSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public TestEndToEndTokenSecurity build() {
            return new TestEndToEndTokenSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
