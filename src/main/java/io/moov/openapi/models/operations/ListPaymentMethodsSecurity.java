...
public class ListPaymentMethodsSecurity {
    ...
    @JsonCreator
    public ListPaymentMethodsSecurity(
    ...
    public ListPaymentMethodsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListPaymentMethodsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListPaymentMethodsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListPaymentMethodsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentMethodsSecurity other = (ListPaymentMethodsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentMethodsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListPaymentMethodsSecurity build() {
            return new ListPaymentMethodsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
