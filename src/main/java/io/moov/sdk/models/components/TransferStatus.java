...
public class TransferStatus {
    ...
    public static final TransferStatus AWAITING_CAPTURE = new TransferStatus("awaiting-capture");
    ...
    private static final Map<String, TransferStatus> createValuesMap() {
        ...
        map.put("awaiting-capture", AWAITING_CAPTURE);
    ...
    private static final Map<String, TransferStatusEnum> createEnumsMap() {
        ...
        map.put("awaiting-capture", TransferStatusEnum.AWAITING_CAPTURE);
