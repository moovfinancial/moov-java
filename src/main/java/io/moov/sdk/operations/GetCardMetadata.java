...
public class GetCardMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<CardMetadataRequest, GetCardMetadataResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CardMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CardMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CardMetadataRequest request) {
        ...
        @Override
        public GetCardMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCardMetadataResponse.Builder resBuilder =
            ...
            GetCardMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardMetadata(Utils.unmarshal(response, new TypeReference<CardMetadata>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CardMetadataRequestError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
