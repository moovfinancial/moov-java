...
public class ConnectAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectAccountRequest, ConnectAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ConnectAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectAccountRequest.class, new TypeReference<ConnectAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectAccountRequest request) {
        ...
        @Override
        public ConnectAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectAccountResponse.Builder resBuilder =
            ...
            ConnectAccountResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw ConnectAccountRequestValidationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
