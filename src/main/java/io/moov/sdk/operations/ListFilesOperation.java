...
public class ListFilesOperation implements RequestOperation<ListFilesRequest, ListFilesResponse> {
    ...
    public ListFilesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListFilesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListFilesRequest request) throws Exception {
    ...
    @Override
    public ListFilesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListFilesResponse.Builder resBuilder = 
            ListFilesResponse
                .builder()
        ...
        ListFilesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<FileDetails> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
