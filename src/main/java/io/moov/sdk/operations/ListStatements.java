...
public class ListStatements {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListStatementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListStatementsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListStatementsRequest request) throws Exception {
        ...
        @Override
        public ListStatementsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListStatementsResponse.Builder resBuilder =
            ...
            ListStatementsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Statement> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withStatements(out);
                    return res;
                } else {
