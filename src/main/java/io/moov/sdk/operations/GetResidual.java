...
public class GetResidual {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetResidualRequest, GetResidualResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetResidualRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetResidualRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetResidualRequest request) {
        ...
        @Override
        public GetResidualResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetResidualResponse.Builder resBuilder =
                    GetResidualResponse
                            .builder()
            ...
            GetResidualResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResidual(Utils.unmarshal(response, new TypeReference<Residual>() {}));
                } else {
