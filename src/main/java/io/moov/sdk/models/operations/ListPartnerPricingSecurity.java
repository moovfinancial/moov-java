...
public class ListPartnerPricingSecurity {
    ...
    @JsonCreator
    public ListPartnerPricingSecurity(
    ...
    public ListPartnerPricingSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListPartnerPricingSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListPartnerPricingSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListPartnerPricingSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPartnerPricingSecurity other = (ListPartnerPricingSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPartnerPricingSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListPartnerPricingSecurity build() {
            return new ListPartnerPricingSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
