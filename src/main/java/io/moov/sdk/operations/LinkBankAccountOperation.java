...
public class LinkBankAccountOperation implements RequestOperation<LinkBankAccountRequest, LinkBankAccountResponse> {
    ...
    public LinkBankAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(LinkBankAccountRequest request) throws Exception {
