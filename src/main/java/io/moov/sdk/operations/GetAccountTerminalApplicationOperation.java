...
public class GetAccountTerminalApplicationOperation implements RequestOperation<GetAccountTerminalApplicationRequest, GetAccountTerminalApplicationResponse> {
    ...
    public GetAccountTerminalApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountTerminalApplicationRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetAccountTerminalApplicationRequest request) throws Exception {
    ...
    @Override
    public GetAccountTerminalApplicationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
