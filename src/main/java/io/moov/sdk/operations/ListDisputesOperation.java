...
public class ListDisputesOperation implements RequestOperation<ListDisputesRequest, ListDisputesResponse> {
    ...
    public ListDisputesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListDisputesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListDisputesRequest request) throws Exception {
        HttpRequest r = buildRequest(request);
        HttpResponse<InputStream> httpRes;
        try {
            httpRes = client.send(r);
            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "409", "429", "4XX", "500", "504", "5XX")) {
    ...
    @Override
    public ListDisputesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListDisputesResponse.Builder resBuilder = 
        ...
        ListDisputesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<Dispute> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withDisputes(out);
                return res;
            } else {
