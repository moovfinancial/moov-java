...
public class LinkBankAccountSecurity {
    ...
    @JsonCreator
    public LinkBankAccountSecurity(
    ...
    public LinkBankAccountSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public LinkBankAccountSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public LinkBankAccountSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public LinkBankAccountSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LinkBankAccountSecurity other = (LinkBankAccountSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LinkBankAccountSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public LinkBankAccountSecurity build() {
            return new LinkBankAccountSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
