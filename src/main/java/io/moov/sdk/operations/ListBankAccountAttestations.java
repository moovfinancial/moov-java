...
public class ListBankAccountAttestations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBankAccountAttestationsRequest, ListBankAccountAttestationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListBankAccountAttestationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBankAccountAttestationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBankAccountAttestationsRequest request) {
        ...
        @Override
        public ListBankAccountAttestationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBankAccountAttestationsResponse.Builder resBuilder =
            ...
            ListBankAccountAttestationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBankAccountAttestationSummaries(Utils.unmarshal(response, new TypeReference<List<BankAccountAttestationSummary>>() {}));
                } else {
