...
public class DeleteDisputeEvidenceFile {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteDisputeEvidenceFileRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDisputeEvidenceFileRequest, DeleteDisputeEvidenceFileResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DeleteDisputeEvidenceFileRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDisputeEvidenceFileRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "409", "429", "4XX", "500", "504", "5XX")) {
        ...
        @Override
        public DeleteDisputeEvidenceFileResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDisputeEvidenceFileResponse.Builder resBuilder =
            ...
            DeleteDisputeEvidenceFileResponse res = resBuilder.build();
