...
public class ListFeePlanAgreements {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListFeePlanAgreementsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFeePlanAgreementsRequest, ListFeePlanAgreementsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListFeePlanAgreementsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFeePlanAgreementsRequest request) throws Exception {
        ...
        @Override
        public ListFeePlanAgreementsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListFeePlanAgreementsResponse.Builder resBuilder =
            ...
            ListFeePlanAgreementsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<FeePlanAgreement> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFeePlanAgreements(out);
                    return res;
                } else {
