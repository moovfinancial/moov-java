...
public class GetTerminalConfiguration {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTerminalConfigurationRequest request) {
        ...
        @Override
        public GetTerminalConfigurationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTerminalConfiguration(Utils.unmarshal(response, new TypeReference<TerminalConfiguration>() {}));
                } else {
