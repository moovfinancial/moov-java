...
public class LinkCard {
    ...
    public static class Sync extends Base
            implements RequestOperation<LinkCardRequest, LinkCardResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(LinkCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LinkCardRequest.class, new TypeReference<LinkCardRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LinkCardRequest request) throws Exception {
        ...
        @Override
        public LinkCardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LinkCardResponse.Builder resBuilder =
                    LinkCardResponse
                            .builder()
            ...
            LinkCardResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    LinkCardError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
