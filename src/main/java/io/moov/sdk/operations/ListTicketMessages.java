...
public class ListTicketMessages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketMessagesRequest request) {
        ...
        @Override
        public ListTicketMessagesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketMessages(Utils.unmarshal(response, new TypeReference<List<TicketMessage>>() {}));
                } else {
