...
public class ListEventTypes {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventTypesRequest, ListEventTypesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListEventTypesRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventTypesRequest request) {
        ...
        @Override
        public ListEventTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListEventTypesResponse.Builder resBuilder =
            ...
            ListEventTypesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventTypes(Utils.unmarshal(response, new TypeReference<List<EventType>>() {}));
                } else {
