...
public class ListIssuedCardAuthorizationEventsOperation implements RequestOperation<ListIssuedCardAuthorizationEventsRequest, ListIssuedCardAuthorizationEventsResponse> {
    ...
    public ListIssuedCardAuthorizationEventsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListIssuedCardAuthorizationEventsRequest request) throws Exception {
