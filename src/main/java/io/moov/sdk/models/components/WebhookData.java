...
public class WebhookData {
    ...
    public static WebhookData of(WebhookDataEventTest value) {
        Utils.checkNotNull(value, "value");
        return new WebhookData(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <li>{@code io.moov.sdk.models.components.WebhookDataTicketCreated}</li>
     * <li>{@code io.moov.sdk.models.components.WebhookDataTicketUpdated}</li>
     * <li>{@code io.moov.sdk.models.components.WebhookDataTicketMessageAdded}</li>
     ...
     * <li>{@code io.moov.sdk.models.components.WebhookDataWalletCreated}</li>
     ...
     * <li>{@code io.moov.sdk.models.components.WebhookDataEventTest}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<WebhookData> {
        ...
        public _Deserializer() {
            super(WebhookData.class, false,
                  ...
                  TypeReferenceWithShape.of(new TypeReference<WebhookDataEventTest>() {}, JsonShape.DEFAULT));
        }
    }
