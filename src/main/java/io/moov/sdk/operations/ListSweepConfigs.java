...
public class ListSweepConfigs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSweepConfigsRequest request) {
        ...
        @Override
        public ListSweepConfigsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSweepConfigs(Utils.unmarshal(response, new TypeReference<List<SweepConfig>>() {}));
                } else {
