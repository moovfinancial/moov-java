...
public class RequirementID {
    ...
    public static final RequirementID UNDERWRITING_CARD_ISSUING_ESTIMATED_ACTIVITY_MONTHLY_VOLUME_RANGE = new RequirementID("underwriting.cardIssuing.estimatedActivity.monthlyVolumeRange");
    ...
    private static final Map<String, RequirementID> createValuesMap() {
        ...
        map.put("underwriting.cardIssuing.estimatedActivity.monthlyVolumeRange", UNDERWRITING_CARD_ISSUING_ESTIMATED_ACTIVITY_MONTHLY_VOLUME_RANGE);
        return map;
    }
    ...
    private static final Map<String, RequirementIDEnum> createEnumsMap() {
        ...
        map.put("underwriting.cardIssuing.estimatedActivity.monthlyVolumeRange", RequirementIDEnum.UNDERWRITING_CARD_ISSUING_ESTIMATED_ACTIVITY_MONTHLY_VOLUME_RANGE);
        return map;
    }
