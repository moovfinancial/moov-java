...
public class RegisterApplePayMerchantDomainsSecurity {
    ...
    @JsonCreator
    public RegisterApplePayMerchantDomainsSecurity(
    ...
    public RegisterApplePayMerchantDomainsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public RegisterApplePayMerchantDomainsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public RegisterApplePayMerchantDomainsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public RegisterApplePayMerchantDomainsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RegisterApplePayMerchantDomainsSecurity other = (RegisterApplePayMerchantDomainsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RegisterApplePayMerchantDomainsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public RegisterApplePayMerchantDomainsSecurity build() {
            return new RegisterApplePayMerchantDomainsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
