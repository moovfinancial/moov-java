...
public class GetSweep {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetSweepRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSweepRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSweepRequest request) {
        ...
        @Override
        public GetSweepResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSweep(Utils.unmarshal(response, new TypeReference<Sweep>() {}));
                } else {
