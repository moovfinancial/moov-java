...
public class UpdateWalletResponse implements Response {
     ...
     * The request completed successfully.
     */
    public UpdateWalletResponse withWallet(Wallet wallet) {
        Utils.checkNotNull(wallet, "wallet");
     ...
     * The request completed successfully.
     */
    public UpdateWalletResponse withWallet(Optional<? extends Wallet> wallet) {
        Utils.checkNotNull(wallet, "wallet");
        this.wallet = wallet;
        return this;
    }

    public UpdateWalletResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
