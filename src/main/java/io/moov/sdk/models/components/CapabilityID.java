...
public class CapabilityID {
    ...
    public static final CapabilityID SEND_FUNDS_WIRE = new CapabilityID("send-funds.wire");
    ...
    private static final Map<String, CapabilityID> createValuesMap() {
        ...
        map.put("send-funds.wire", SEND_FUNDS_WIRE);
    ...
    private static final Map<String, CapabilityIDEnum> createEnumsMap() {
        ...
        map.put("send-funds.wire", CapabilityIDEnum.SEND_FUNDS_WIRE);
