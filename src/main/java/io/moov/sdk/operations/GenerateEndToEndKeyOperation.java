...
public class GenerateEndToEndKeyOperation implements RequestOperation<GenerateEndToEndKeyRequest, GenerateEndToEndKeyResponse> {
    ...
    public GenerateEndToEndKeyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GenerateEndToEndKeyRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GenerateEndToEndKeyRequest request) throws Exception {
    ...
    @Override
    public GenerateEndToEndKeyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GenerateEndToEndKeyResponse.Builder resBuilder = 
        ...
        GenerateEndToEndKeyResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                JSONWebKey out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withJSONWebKey(out);
                return res;
            } else {
