...
public class GetTransferOperation implements RequestOperation<GetTransferRequest, GetTransferResponse> {
    ...
    public GetTransferOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTransferRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetTransferRequest request) throws Exception {
    ...
    @Override
    public GetTransferResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
