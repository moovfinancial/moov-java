...
public class RefundCardStatus {
    ...
    public static final RefundCardStatus CLEARED_EXTERNALLY = new RefundCardStatus("cleared-externally");
    ...
    private static final Map<String, RefundCardStatusEnum> createEnumsMap() {
        ...
        map.put("cleared-externally", RefundCardStatusEnum.CLEARED_EXTERNALLY);
        return map;
    }
