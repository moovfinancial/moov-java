...
public class CreateProduct {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateProductRequest, CreateProductResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateProductRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateProductRequest.class, new TypeReference<CreateProductRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateProductRequest request) throws Exception {
        ...
        @Override
        public CreateProductResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateProductResponse.Builder resBuilder =
            ...
            CreateProductResponse res = resBuilder.build();
