...
public class CardTransactionFailureCode {
    ...
    public static final CardTransactionFailureCode ACCOUNT_CLOSED = new CardTransactionFailureCode("account-closed");
    public static final CardTransactionFailureCode ACCOUNT_NOT_ACTIVATED = new CardTransactionFailureCode("account-not-activated");
    public static final CardTransactionFailureCode AUTHENTICATION_FAILED = new CardTransactionFailureCode("authentication-failed");
    public static final CardTransactionFailureCode AUTHENTICATION_REQUIRED = new CardTransactionFailureCode("authentication-required");
    public static final CardTransactionFailureCode CARDHOLDER_ACTION_REQUIRED = new CardTransactionFailureCode("cardholder-action-required");
    public static final CardTransactionFailureCode FORMAT_ERROR = new CardTransactionFailureCode("format-error");
    public static final CardTransactionFailureCode INVALID_PIN = new CardTransactionFailureCode("invalid-pin");
    public static final CardTransactionFailureCode OFFLINE_APPROVED = new CardTransactionFailureCode("offline-approved");
    public static final CardTransactionFailureCode OFFLINE_DECLINED = new CardTransactionFailureCode("offline-declined");
    public static final CardTransactionFailureCode PARTIAL_APPROVAL = new CardTransactionFailureCode("partial-approval");
    public static final CardTransactionFailureCode PAYMENT_STOPPED = new CardTransactionFailureCode("payment-stopped");
    public static final CardTransactionFailureCode PIN_REQUIRED = new CardTransactionFailureCode("pin-required");
    public static final CardTransactionFailureCode RECORD_NOT_FOUND = new CardTransactionFailureCode("record-not-found");
    public static final CardTransactionFailureCode SURCHARGE_NOT_PERMITTED = new CardTransactionFailureCode("surcharge-not-permitted");
    public static final CardTransactionFailureCode TRANSACTION_REVERSED = new CardTransactionFailureCode("transaction-reversed");
    public static final CardTransactionFailureCode VERIFICATION_FAILED = new CardTransactionFailureCode("verification-failed");
    ...
    private static final Map<String, CardTransactionFailureCode> createValuesMap() {
        ...
        map.put("account-not-activated", ACCOUNT_NOT_ACTIVATED);
        map.put("authentication-failed", AUTHENTICATION_FAILED);
        map.put("authentication-required", AUTHENTICATION_REQUIRED);
        map.put("cardholder-action-required", CARDHOLDER_ACTION_REQUIRED);
        map.put("format-error", FORMAT_ERROR);
        map.put("invalid-pin", INVALID_PIN);
        map.put("offline-approved", OFFLINE_APPROVED);
        map.put("offline-declined", OFFLINE_DECLINED);
        map.put("partial-approval", PARTIAL_APPROVAL);
        map.put("payment-stopped", PAYMENT_STOPPED);
        map.put("pin-required", PIN_REQUIRED);
        map.put("record-not-found", RECORD_NOT_FOUND);
        map.put("surcharge-not-permitted", SURCHARGE_NOT_PERMITTED);
        map.put("transaction-reversed", TRANSACTION_REVERSED);
        map.put("verification-failed", VERIFICATION_FAILED);
    ...
    private static final Map<String, CardTransactionFailureCodeEnum> createEnumsMap() {
        ...
        map.put("account-closed", CardTransactionFailureCodeEnum.ACCOUNT_CLOSED);
        map.put("account-not-activated", CardTransactionFailureCodeEnum.ACCOUNT_NOT_ACTIVATED);
        map.put("authentication-failed", CardTransactionFailureCodeEnum.AUTHENTICATION_FAILED);
        map.put("authentication-required", CardTransactionFailureCodeEnum.AUTHENTICATION_REQUIRED);
        map.put("cardholder-action-required", CardTransactionFailureCodeEnum.CARDHOLDER_ACTION_REQUIRED);
        map.put("format-error", CardTransactionFailureCodeEnum.FORMAT_ERROR);
        map.put("invalid-pin", CardTransactionFailureCodeEnum.INVALID_PIN);
        map.put("offline-approved", CardTransactionFailureCodeEnum.OFFLINE_APPROVED);
        map.put("offline-declined", CardTransactionFailureCodeEnum.OFFLINE_DECLINED);
        map.put("partial-approval", CardTransactionFailureCodeEnum.PARTIAL_APPROVAL);
        map.put("payment-stopped", CardTransactionFailureCodeEnum.PAYMENT_STOPPED);
        map.put("pin-required", CardTransactionFailureCodeEnum.PIN_REQUIRED);
        map.put("record-not-found", CardTransactionFailureCodeEnum.RECORD_NOT_FOUND);
        map.put("surcharge-not-permitted", CardTransactionFailureCodeEnum.SURCHARGE_NOT_PERMITTED);
        map.put("transaction-reversed", CardTransactionFailureCodeEnum.TRANSACTION_REVERSED);
        map.put("verification-failed", CardTransactionFailureCodeEnum.VERIFICATION_FAILED);
