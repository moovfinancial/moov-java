...
public class ListOnboardingInvites {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOnboardingInvitesRequest request) {
        ...
        @Override
        public ListOnboardingInvitesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOnboardingInvites(Utils.unmarshal(response, new TypeReference<List<OnboardingInvite>>() {}));
                } else {
