...
public class ListInvoicePayments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListInvoicePaymentsRequest, ListInvoicePaymentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListInvoicePaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInvoicePaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInvoicePaymentsRequest request) {
        ...
        @Override
        public ListInvoicePaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListInvoicePaymentsResponse.Builder resBuilder =
            ...
            ListInvoicePaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvoicePayments(Utils.unmarshal(response, new TypeReference<List<InvoicePayment>>() {}));
                } else {
