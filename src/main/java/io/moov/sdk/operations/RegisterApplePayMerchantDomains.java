...
public class RegisterApplePayMerchantDomains {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RegisterApplePayMerchantDomainsRequest request) {
        ...
        @Override
        public RegisterApplePayMerchantDomainsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApplePayMerchantDomains(Utils.unmarshal(response, new TypeReference<ApplePayMerchantDomains>() {}));
                } else {
