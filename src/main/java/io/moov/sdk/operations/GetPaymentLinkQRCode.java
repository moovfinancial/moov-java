...
public class GetPaymentLinkQRCode {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentLinkQRCodeRequest, GetPaymentLinkQRCodeResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentLinkQRCodeRequest request) {
        ...
        @Override
        public GetPaymentLinkQRCodeResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQRCode(Utils.unmarshal(response, new TypeReference<QRCode>() {}));
