...
public class GetTermsOfServiceTokenOperation implements RequestOperation<GetTermsOfServiceTokenRequest, GetTermsOfServiceTokenResponse> {
    ...
    public GetTermsOfServiceTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTermsOfServiceTokenRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetTermsOfServiceTokenRequest request) throws Exception {
    ...
    @Override
    public GetTermsOfServiceTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetTermsOfServiceTokenResponse.Builder resBuilder = 
        ...
        GetTermsOfServiceTokenResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                TermsOfServiceToken out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withTermsOfServiceToken(out);
                return res;
            } else {
