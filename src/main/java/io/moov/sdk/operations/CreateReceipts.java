...
public class CreateReceipts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(List<ReceiptRequest> request) {
        ...
        @Override
        public CreateReceiptsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReceiptResponses(Utils.unmarshal(response, new TypeReference<List<ReceiptResponse>>() {}));
                } else {
