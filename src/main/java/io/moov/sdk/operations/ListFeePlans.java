...
public class ListFeePlans {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFeePlansRequest request) {
        ...
        @Override
        public ListFeePlansResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFeePlans(Utils.unmarshal(response, new TypeReference<List<FeePlan>>() {}));
                } else {
