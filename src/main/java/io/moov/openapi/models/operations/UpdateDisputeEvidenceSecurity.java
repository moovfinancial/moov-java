...
public class UpdateDisputeEvidenceSecurity {
    ...
    @JsonCreator
    public UpdateDisputeEvidenceSecurity(
    ...
    public UpdateDisputeEvidenceSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdateDisputeEvidenceSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdateDisputeEvidenceSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdateDisputeEvidenceSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDisputeEvidenceSecurity other = (UpdateDisputeEvidenceSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateDisputeEvidenceSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdateDisputeEvidenceSecurity build() {
            return new UpdateDisputeEvidenceSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
