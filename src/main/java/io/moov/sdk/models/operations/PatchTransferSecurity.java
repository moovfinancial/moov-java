...
public class PatchTransferSecurity {
    ...
    public PatchTransferSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public PatchTransferSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public PatchTransferSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public PatchTransferSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchTransferSecurity other = (PatchTransferSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchTransferSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public PatchTransferSecurity build() {
            return new PatchTransferSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
