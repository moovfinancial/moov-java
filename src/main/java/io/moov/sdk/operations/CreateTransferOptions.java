...
public class CreateTransferOptions {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTransferOptionsRequest, CreateTransferOptionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTransferOptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTransferOptionsRequest.class, new TypeReference<CreateTransferOptionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTransferOptionsRequest request) {
        ...
        @Override
        public CreateTransferOptionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTransferOptionsResponse.Builder resBuilder =
            ...
            CreateTransferOptionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransferOptions(Utils.unmarshal(response, new TypeReference<TransferOptions>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw TransferOptionsValidationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
