...
public class GetTermsOfServiceToken {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetTermsOfServiceTokenRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTermsOfServiceTokenRequest, GetTermsOfServiceTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetTermsOfServiceTokenRequest request) throws Exception {
