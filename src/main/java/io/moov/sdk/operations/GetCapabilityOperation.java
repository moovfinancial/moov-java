...
public class GetCapabilityOperation implements RequestOperation<GetCapabilityRequest, GetCapabilityResponse> {
    ...
    public GetCapabilityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCapabilityRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetCapabilityRequest request) throws Exception {
    ...
    @Override
    public GetCapabilityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetCapabilityResponse.Builder resBuilder = 
        ...
        GetCapabilityResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                Capability out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withCapability(out);
                return res;
            } else {
