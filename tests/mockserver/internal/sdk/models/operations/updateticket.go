...
type UpdateTicketGlobals struct {
...
func (u UpdateTicketGlobals) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateTicketGlobals) UnmarshalJSON(data []byte) error {
...
func (o *UpdateTicketGlobals) GetXMoovVersion() *string {
	if o == nil {
		return nil
	}
...
func (u UpdateTicketRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}
...
func (o *UpdateTicketRequest) GetXMoovVersion() *string {
	if o == nil {
		return nil
	}
	return o.XMoovVersion
...
func (o *UpdateTicketRequest) GetAccountID() string {
	if o == nil {
		return ""
	}
	return o.AccountID
...
func (o *UpdateTicketResponse) GetTicket() *components.Ticket {
	if o == nil {
		return nil
	}
	return o.Ticket
...
func (o *UpdateTicketResponse) GetHeaders() map[string][]string {
	if o == nil {
