...
public class GetAccountOperation implements RequestOperation<GetAccountRequest, GetAccountResponse> {
    ...
    public GetAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountRequest request) throws Exception {
