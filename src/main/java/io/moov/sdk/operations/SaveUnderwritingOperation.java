...
public class SaveUnderwritingOperation implements RequestOperation<SaveUnderwritingRequest, SaveUnderwritingResponse> {
    ...
    public SaveUnderwritingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(SaveUnderwritingRequest request) throws Exception {
        String url = Utils.generateURL(
                SaveUnderwritingRequest.class,
                this.baseUrl,
