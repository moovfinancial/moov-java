...
public class MarkInvoicePaidError extends MoovError {
    ...
    /**
    * Parse a response into an instance of MarkInvoicePaidError. If deserialization of the response body fails,
    * the resulting MarkInvoicePaidError instance will have a null data() value and a non-null deserializationException().
    */
    public static MarkInvoicePaidError from(HttpResponse<InputStream> response) {
        try {
            byte[] bytes = Utils.extractByteArrayFromBody(response);
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new MarkInvoicePaidError(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new MarkInvoicePaidError(response.statusCode(), null, response, null, e);
        }
    }
