...
public class ListRepresentatives {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepresentativesRequest request) {
        ...
        @Override
        public ListRepresentativesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepresentatives(Utils.unmarshal(response, new TypeReference<List<Representative>>() {}));
                } else {
