...
public class CreateTransferConfig {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTransferConfigRequest, CreateTransferConfigResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTransferConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTransferConfigRequest.class, new TypeReference<CreateTransferConfigRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTransferConfigRequest request) {
        ...
        @Override
        public CreateTransferConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTransferConfigResponse.Builder resBuilder =
            ...
            CreateTransferConfigResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransferConfig(Utils.unmarshal(response, new TypeReference<TransferConfig>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw TransferConfigValidationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
