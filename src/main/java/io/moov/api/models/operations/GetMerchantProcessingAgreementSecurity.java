...
public class GetMerchantProcessingAgreementSecurity {
    ...
    @JsonCreator
    public GetMerchantProcessingAgreementSecurity(
    ...
    public GetMerchantProcessingAgreementSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetMerchantProcessingAgreementSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetMerchantProcessingAgreementSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetMerchantProcessingAgreementSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMerchantProcessingAgreementSecurity other = (GetMerchantProcessingAgreementSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMerchantProcessingAgreementSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetMerchantProcessingAgreementSecurity build() {
            return new GetMerchantProcessingAgreementSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
