...
public class ReverseTransferSecurity {
    ...
    @JsonCreator
    public ReverseTransferSecurity(
    ...
    public ReverseTransferSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ReverseTransferSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ReverseTransferSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ReverseTransferSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReverseTransferSecurity other = (ReverseTransferSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReverseTransferSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ReverseTransferSecurity build() {
            return new ReverseTransferSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
