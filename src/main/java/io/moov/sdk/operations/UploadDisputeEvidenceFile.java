...
public class UploadDisputeEvidenceFile {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadDisputeEvidenceFileRequest request) {
        ...
        @Override
        public UploadDisputeEvidenceFileResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEvidenceUploadResponse(Utils.unmarshal(response, new TypeReference<EvidenceUploadResponse>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw FileUploadValidationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
