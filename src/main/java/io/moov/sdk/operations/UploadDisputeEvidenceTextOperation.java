...
public class UploadDisputeEvidenceTextOperation implements RequestOperation<UploadDisputeEvidenceTextRequest, UploadDisputeEvidenceTextResponse> {
    ...
    public UploadDisputeEvidenceTextOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UploadDisputeEvidenceTextRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(UploadDisputeEvidenceTextRequest request) throws Exception {
    ...
    @Override
    public UploadDisputeEvidenceTextResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        UploadDisputeEvidenceTextResponse.Builder resBuilder = 
        ...
        UploadDisputeEvidenceTextResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "201")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                EvidenceTextResponse out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withEvidenceTextResponse(out);
                return res;
            } else {
