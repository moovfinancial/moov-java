...
public class DeleteInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteInvoiceRequest, DeleteInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteInvoiceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteInvoiceRequest request) {
        ...
        @Override
        public DeleteInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteInvoiceResponse.Builder resBuilder =
            ...
            DeleteInvoiceResponse res = resBuilder.build();
