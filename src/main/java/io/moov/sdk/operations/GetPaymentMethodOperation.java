...
public class GetPaymentMethodOperation implements RequestOperation<GetPaymentMethodRequest, GetPaymentMethodResponse> {
    ...
    public GetPaymentMethodOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetPaymentMethodRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetPaymentMethodRequest request) throws Exception {
    ...
    @Override
    public GetPaymentMethodResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetPaymentMethodResponse.Builder resBuilder = 
        ...
        GetPaymentMethodResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                PaymentMethod out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withPaymentMethod(out);
                return res;
            } else {
