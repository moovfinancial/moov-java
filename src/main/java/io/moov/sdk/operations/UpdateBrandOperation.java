...
public class UpdateBrandOperation implements RequestOperation<UpdateBrandRequest, UpdateBrandResponse> {
    ...
    public UpdateBrandOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateBrandRequest request) throws Exception {
