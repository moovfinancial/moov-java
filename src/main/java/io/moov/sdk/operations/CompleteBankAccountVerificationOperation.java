...
public class CompleteBankAccountVerificationOperation implements RequestOperation<CompleteBankAccountVerificationRequest, CompleteBankAccountVerificationResponse> {
    ...
    public CompleteBankAccountVerificationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CompleteBankAccountVerificationRequest request) throws Exception {
