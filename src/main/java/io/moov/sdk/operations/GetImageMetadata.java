...
public class GetImageMetadata {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetImageMetadataRequest request) {
        ...
        @Override
        public GetImageMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withImageMetadata(Utils.unmarshal(response, new TypeReference<ImageMetadata>() {}));
                } else {
