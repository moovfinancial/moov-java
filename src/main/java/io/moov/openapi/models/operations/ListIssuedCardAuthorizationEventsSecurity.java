...
public class ListIssuedCardAuthorizationEventsSecurity {
    ...
    @JsonCreator
    public ListIssuedCardAuthorizationEventsSecurity(
    ...
    public ListIssuedCardAuthorizationEventsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListIssuedCardAuthorizationEventsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListIssuedCardAuthorizationEventsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListIssuedCardAuthorizationEventsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListIssuedCardAuthorizationEventsSecurity other = (ListIssuedCardAuthorizationEventsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListIssuedCardAuthorizationEventsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListIssuedCardAuthorizationEventsSecurity build() {
            return new ListIssuedCardAuthorizationEventsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
