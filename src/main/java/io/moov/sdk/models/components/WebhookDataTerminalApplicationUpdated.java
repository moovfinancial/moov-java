...
public class WebhookDataTerminalApplicationUpdated {
    ...
    @JsonCreator
    public WebhookDataTerminalApplicationUpdated(
     ...
     * Status of the terminal application.
     */
    public WebhookDataTerminalApplicationUpdated withStatus(TerminalApplicationStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        WebhookDataTerminalApplicationUpdated other = (WebhookDataTerminalApplicationUpdated) o;
        return 
    ...
    public String toString() {
        return Utils.toString(WebhookDataTerminalApplicationUpdated.class,
