...
public class ListPaymentMethodsOperation implements RequestOperation<ListPaymentMethodsRequest, ListPaymentMethodsResponse> {
    ...
    public ListPaymentMethodsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPaymentMethodsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListPaymentMethodsRequest request) throws Exception {
    ...
    @Override
    public ListPaymentMethodsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListPaymentMethodsResponse.Builder resBuilder = 
        ...
        ListPaymentMethodsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<PaymentMethod> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withPaymentMethods(out);
                return res;
            } else {
