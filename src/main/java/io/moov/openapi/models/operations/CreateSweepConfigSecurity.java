...
public class CreateSweepConfigSecurity {
    ...
    @JsonCreator
    public CreateSweepConfigSecurity(
    ...
    public CreateSweepConfigSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CreateSweepConfigSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CreateSweepConfigSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CreateSweepConfigSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateSweepConfigSecurity other = (CreateSweepConfigSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateSweepConfigSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CreateSweepConfigSecurity build() {
            return new CreateSweepConfigSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
