...
public class GetTerminalApplicationOperation implements RequestOperation<GetTerminalApplicationRequest, GetTerminalApplicationResponse> {
    ...
    public GetTerminalApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTerminalApplicationRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetTerminalApplicationRequest request) throws Exception {
    ...
    @Override
    public GetTerminalApplicationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
