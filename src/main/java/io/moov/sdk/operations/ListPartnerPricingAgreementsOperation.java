...
public class ListPartnerPricingAgreementsOperation implements RequestOperation<ListPartnerPricingAgreementsRequest, ListPartnerPricingAgreementsResponse> {
    ...
    public ListPartnerPricingAgreementsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPartnerPricingAgreementsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListPartnerPricingAgreementsRequest request) throws Exception {
    ...
    @Override
    public ListPartnerPricingAgreementsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListPartnerPricingAgreementsResponse.Builder resBuilder = 
        ...
        ListPartnerPricingAgreementsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<PartnerPricingAgreement> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withPartnerPricingAgreements(out);
                return res;
            } else {
