 ...
 */
@Deprecated
public class BillingSummaryAdjustmentFees {
    /**
    ...
    @JsonCreator
    public BillingSummaryAdjustmentFees(
     ...
     * A 3-letter ISO 4217 currency code.
     */
    public BillingSummaryAdjustmentFees withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * <p>For example, $12.987654321 is '12.987654321'.
     */
    public BillingSummaryAdjustmentFees withValueDecimal(String valueDecimal) {
        Utils.checkNotNull(valueDecimal, "valueDecimal");
        this.valueDecimal = valueDecimal;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BillingSummaryAdjustmentFees other = (BillingSummaryAdjustmentFees) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BillingSummaryAdjustmentFees.class,
                "currency", currency,
    ...
    public final static class Builder {
        ...
        public BillingSummaryAdjustmentFees build() {

            return new BillingSummaryAdjustmentFees(
                currency, valueDecimal);
        }
