...
public class ListIssuedCardsSecurity {
    ...
    @JsonCreator
    public ListIssuedCardsSecurity(
    ...
    public ListIssuedCardsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListIssuedCardsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListIssuedCardsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListIssuedCardsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListIssuedCardsSecurity other = (ListIssuedCardsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListIssuedCardsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListIssuedCardsSecurity build() {
            return new ListIssuedCardsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
