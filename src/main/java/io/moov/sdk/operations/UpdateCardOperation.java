...
public class UpdateCardOperation implements RequestOperation<UpdateCardRequest, UpdateCardResponse> {
    ...
    public UpdateCardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCardRequest request) throws Exception {
