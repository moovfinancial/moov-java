...
public class ListFeePlanAgreementsSecurity {
    ...
    @JsonCreator
    public ListFeePlanAgreementsSecurity(
    ...
    public ListFeePlanAgreementsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListFeePlanAgreementsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListFeePlanAgreementsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListFeePlanAgreementsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListFeePlanAgreementsSecurity other = (ListFeePlanAgreementsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListFeePlanAgreementsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListFeePlanAgreementsSecurity build() {
            return new ListFeePlanAgreementsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
