...
public class ListTerminalApplicationsOperation implements RequestOperation<ListTerminalApplicationsRequest, ListTerminalApplicationsResponse> {
    ...
    public ListTerminalApplicationsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTerminalApplicationsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListTerminalApplicationsRequest request) throws Exception {
    ...
    @Override
    public ListTerminalApplicationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListTerminalApplicationsResponse.Builder resBuilder = 
        ...
        ListTerminalApplicationsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<TerminalApplication> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withTerminalApplications(out);
                return res;
            } else {
