...
public class GetFileDetails {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFileDetailsRequest request) {
        ...
        @Override
        public GetFileDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFileDetails(Utils.unmarshal(response, new TypeReference<FileDetails>() {}));
                } else {
