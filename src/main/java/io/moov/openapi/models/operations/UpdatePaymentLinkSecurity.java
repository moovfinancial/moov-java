...
public class UpdatePaymentLinkSecurity {
    ...
    @JsonCreator
    public UpdatePaymentLinkSecurity(
    ...
    public UpdatePaymentLinkSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdatePaymentLinkSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdatePaymentLinkSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdatePaymentLinkSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentLinkSecurity other = (UpdatePaymentLinkSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentLinkSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdatePaymentLinkSecurity build() {
            return new UpdatePaymentLinkSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
