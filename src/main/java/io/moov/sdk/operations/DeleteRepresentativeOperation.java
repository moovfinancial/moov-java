...
public class DeleteRepresentativeOperation implements RequestOperation<DeleteRepresentativeRequest, DeleteRepresentativeResponse> {
    ...
    public DeleteRepresentativeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteRepresentativeRequest request) throws Exception {
