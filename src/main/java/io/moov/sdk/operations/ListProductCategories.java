...
public class ListProductCategories {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListProductCategoriesResponse> {
        ...
        @Override
        public ListProductCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListProductCategoriesResponse.Builder resBuilder =
            ...
            ListProductCategoriesResponse res = resBuilder.build();
