...
public class GetBankAccountAttestationEligibility {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getBankAccountAttestationEligibility",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBankAccountAttestationEligibilityRequest, GetBankAccountAttestationEligibilityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetBankAccountAttestationEligibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBankAccountAttestationEligibilityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBankAccountAttestationEligibilityRequest request) {
        ...
        @Override
        public GetBankAccountAttestationEligibilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBankAccountAttestationEligibilityResponse.Builder resBuilder =
            ...
            GetBankAccountAttestationEligibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBankAccountAttestationEligibility(Utils.unmarshal(response, new TypeReference<BankAccountAttestationEligibility>() {}));
                } else {
