...
public class GetTransferRiskOutcomes {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransferRiskOutcomesRequest, GetTransferRiskOutcomesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTransferRiskOutcomesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransferRiskOutcomesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransferRiskOutcomesRequest request) {
        ...
        @Override
        public GetTransferRiskOutcomesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransferRiskOutcomesResponse.Builder resBuilder =
            ...
            GetTransferRiskOutcomesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPartnerRiskOutcomesResponse(Utils.unmarshal(response, new TypeReference<PartnerRiskOutcomesResponse>() {}));
                } else {
