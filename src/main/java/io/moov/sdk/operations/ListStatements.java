...
public class ListStatements {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListStatementsRequest request) {
        ...
        @Override
        public ListStatementsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStatements(Utils.unmarshal(response, new TypeReference<List<Statement>>() {}));
                } else {
