...
public class CreateReceiptsOperation implements RequestOperation<List<ReceiptRequest>, CreateReceiptsResponse> {
    ...
    public CreateReceiptsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(List<ReceiptRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(List<ReceiptRequest> request) throws Exception {
    ...
    @Override
    public CreateReceiptsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreateReceiptsResponse.Builder resBuilder = 
        ...
        CreateReceiptsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "201")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<ReceiptResponse> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withReceiptResponses(out);
                return res;
            } else {
