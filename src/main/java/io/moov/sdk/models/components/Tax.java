 ...
 * Tax
 * 
 * <p>The amount of tax applied to the payment link.
 */
public class Tax {
    /**
     ...
     * A 3-letter ISO 4217 currency code.
     */
    public Tax withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * A 3-letter ISO 4217 currency code.
     */
    public Tax withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * <p>For example, $12.987654321 is '12.987654321'.
     */
    public Tax withValueDecimal(String valueDecimal) {
        Utils.checkNotNull(valueDecimal, "valueDecimal");
     ...
     * <p>For example, $12.987654321 is '12.987654321'.
     */
    public Tax withValueDecimal(Optional<String> valueDecimal) {
        Utils.checkNotNull(valueDecimal, "valueDecimal");
        this.valueDecimal = valueDecimal;
        return this;
    }
