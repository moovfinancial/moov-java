...
public class GetRefundOperation implements RequestOperation<GetRefundRequest, GetRefundResponse> {
    ...
    public GetRefundOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRefundRequest request) throws Exception {
    ...
    @Override
    public GetRefundResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetRefundResponse.Builder resBuilder = 
            GetRefundResponse
                .builder()
        ...
        GetRefundResponse res = resBuilder.build();
