...
public class ListPaymentLinks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentLinksRequest, ListPaymentLinksResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentLinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentLinksRequest request) {
        ...
        @Override
        public ListPaymentLinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentLinksResponse.Builder resBuilder =
            ...
            ListPaymentLinksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentLinks(Utils.unmarshal(response, new TypeReference<List<PaymentLink>>() {}));
                } else {
