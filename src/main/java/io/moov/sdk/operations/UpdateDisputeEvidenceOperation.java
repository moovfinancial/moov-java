...
public class UpdateDisputeEvidenceOperation implements RequestOperation<UpdateDisputeEvidenceRequest, UpdateDisputeEvidenceResponse> {
    ...
    public UpdateDisputeEvidenceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateDisputeEvidenceRequest request) throws Exception {
