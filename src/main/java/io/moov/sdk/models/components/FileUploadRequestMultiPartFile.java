...
public class FileUploadRequestMultiPartFile {
    ...
    @JsonCreator
    public FileUploadRequestMultiPartFile(
            String fileName,
            byte[] content) {
    ...
    public FileUploadRequestMultiPartFile withContent(byte[] content) {
        Utils.checkNotNull(content, "content");
        this.content = content;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(FileUploadRequestMultiPartFile.class,
                "fileName", fileName,
                "content", content);
    }
