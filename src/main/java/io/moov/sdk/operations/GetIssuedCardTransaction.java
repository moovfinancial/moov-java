...
public class GetIssuedCardTransaction {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetIssuedCardTransactionRequest request) {
        ...
        @Override
        public GetIssuedCardTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIssuedCardTransaction(Utils.unmarshal(response, new TypeReference<IssuedCardTransaction>() {}));
                } else {
