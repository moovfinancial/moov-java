...
public class LinkCardOperation implements RequestOperation<LinkCardRequest, LinkCardResponse> {
    ...
    public LinkCardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(LinkCardRequest request) throws Exception {
