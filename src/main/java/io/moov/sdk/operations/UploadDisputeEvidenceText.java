...
public class UploadDisputeEvidenceText {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadDisputeEvidenceTextRequest request) {
        ...
        @Override
        public UploadDisputeEvidenceTextResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEvidenceTextResponse(Utils.unmarshal(response, new TypeReference<EvidenceTextResponse>() {}));
                } else {
