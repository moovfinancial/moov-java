...
public class GetEnrichmentProfile {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEnrichmentProfileRequest request) {
        ...
        @Override
        public GetEnrichmentProfileResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnrichedBusinessResponse(Utils.unmarshal(response, new TypeReference<EnrichedBusinessResponse>() {}));
                } else {
