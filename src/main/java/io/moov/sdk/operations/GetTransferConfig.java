...
public class GetTransferConfig {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransferConfigRequest, GetTransferConfigResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTransferConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransferConfigRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransferConfigRequest request) {
        ...
        @Override
        public GetTransferConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransferConfigResponse.Builder resBuilder =
            ...
            GetTransferConfigResponse res = resBuilder.build();
