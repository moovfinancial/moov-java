...
public class DeleteDisputeEvidenceFileOperation implements RequestOperation<DeleteDisputeEvidenceFileRequest, DeleteDisputeEvidenceFileResponse> {
    ...
    public DeleteDisputeEvidenceFileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteDisputeEvidenceFileRequest request) throws Exception {
