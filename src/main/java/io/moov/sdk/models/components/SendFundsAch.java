...
public class SendFundsAch {
    ...
    public SendFundsAch withEstimatedActivity(EstimatedActivity estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
    ...
    public SendFundsAch withEstimatedActivity(Optional<? extends EstimatedActivity> estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
        this.estimatedActivity = estimatedActivity;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SendFundsAch other = (SendFundsAch) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SendFundsAch.class,
    ...
    public final static class Builder {
        ...
        public SendFundsAch build() {

            return new SendFundsAch(
                estimatedActivity);
        }
