...
public class CreateReversal {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateReversalRequest request) {
        ...
        @Override
        public CreateReversalResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200", "202")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReversal(Utils.unmarshal(response, new TypeReference<Reversal>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw ReversalValidationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
