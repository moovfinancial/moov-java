 ...
 */
public class TransferPaymentMethodsCard {
    /**
     * ID of the card.
     */
    @JsonProperty("cardID")
    ...
    @JsonCreator
    public TransferPaymentMethodsCard(
     ...
     * ID of the card.
     */
    public TransferPaymentMethodsCard withCardID(String cardID) {
        Utils.checkNotNull(cardID, "cardID");
        this.cardID = cardID;
        return this;
    }
     ...
     * platform.
     */
    public TransferPaymentMethodsCard withFingerprint(String fingerprint) {
        Utils.checkNotNull(fingerprint, "fingerprint");
        this.fingerprint = fingerprint;
        return this;
    }
     ...
     * The card brand.
     */
    public TransferPaymentMethodsCard withBrand(CardBrand brand) {
        Utils.checkNotNull(brand, "brand");
        this.brand = brand;
        return this;
    }
     ...
     * The type of the card.
     */
    public TransferPaymentMethodsCard withCardType(CardType cardType) {
        Utils.checkNotNull(cardType, "cardType");
        this.cardType = cardType;
        return this;
    }
     ...
     * Last four digits of the card number
     */
    public TransferPaymentMethodsCard withLastFourCardNumber(String lastFourCardNumber) {
        Utils.checkNotNull(lastFourCardNumber, "lastFourCardNumber");
        this.lastFourCardNumber = lastFourCardNumber;
        return this;
    }
     ...
     * issued the card.
     */
    public TransferPaymentMethodsCard withBin(String bin) {
        Utils.checkNotNull(bin, "bin");
        this.bin = bin;
        return this;
    }
     ...
     * The expiration date of the card or token.
     */
    public TransferPaymentMethodsCard withExpiration(CardExpiration expiration) {
        Utils.checkNotNull(expiration, "expiration");
        this.expiration = expiration;
        return this;
    }
     ...
     * The name of the cardholder as it appears on the card.
     */
    public TransferPaymentMethodsCard withHolderName(String holderName) {
        Utils.checkNotNull(holderName, "holderName");
     ...
     * The name of the cardholder as it appears on the card.
     */
    public TransferPaymentMethodsCard withHolderName(Optional<String> holderName) {
        Utils.checkNotNull(holderName, "holderName");
        this.holderName = holderName;
        return this;
    }
     ...
     * The results of submitting cardholder data to a card network for verification.
     */
    public TransferPaymentMethodsCard withCardVerification(CardVerification cardVerification) {
        Utils.checkNotNull(cardVerification, "cardVerification");
        this.cardVerification = cardVerification;
        return this;
    }
     ...
     * Financial institution that issued the card.
     */
    public TransferPaymentMethodsCard withIssuer(String issuer) {
        Utils.checkNotNull(issuer, "issuer");
     ...
     * Financial institution that issued the card.
     */
    public TransferPaymentMethodsCard withIssuer(Optional<String> issuer) {
        Utils.checkNotNull(issuer, "issuer");
        this.issuer = issuer;
        return this;
    }
     ...
     * Country where the card was issued.
     */
    public TransferPaymentMethodsCard withIssuerCountry(String issuerCountry) {
        Utils.checkNotNull(issuerCountry, "issuerCountry");
     ...
     * Country where the card was issued.
     */
    public TransferPaymentMethodsCard withIssuerCountry(Optional<String> issuerCountry) {
        Utils.checkNotNull(issuerCountry, "issuerCountry");
        this.issuerCountry = issuerCountry;
        return this;
    }
     ...
     * Indicates cardholder has authorized card to be stored for future payments.
     */
    public TransferPaymentMethodsCard withCardOnFile(boolean cardOnFile) {
        Utils.checkNotNull(cardOnFile, "cardOnFile");
     ...
     * Indicates cardholder has authorized card to be stored for future payments.
     */
    public TransferPaymentMethodsCard withCardOnFile(Optional<Boolean> cardOnFile) {
        Utils.checkNotNull(cardOnFile, "cardOnFile");
        this.cardOnFile = cardOnFile;
        return this;
    }
     ...
     * The results of the most recent card update request.
     */
    public TransferPaymentMethodsCard withCardAccountUpdater(CardAccountUpdater cardAccountUpdater) {
        Utils.checkNotNull(cardAccountUpdater, "cardAccountUpdater");
     ...
     * The results of the most recent card update request.
     */
    public TransferPaymentMethodsCard withCardAccountUpdater(Optional<? extends CardAccountUpdater> cardAccountUpdater) {
        Utils.checkNotNull(cardAccountUpdater, "cardAccountUpdater");
        this.cardAccountUpdater = cardAccountUpdater;
        return this;
    }
     ...
     * Indicates which level of domestic push-to-card transfer is supported by the card, if any.
     */
    public TransferPaymentMethodsCard withDomesticPushToCard(DomesticPushToCard domesticPushToCard) {
        Utils.checkNotNull(domesticPushToCard, "domesticPushToCard");
     ...
     * Indicates which level of domestic push-to-card transfer is supported by the card, if any.
     */
    public TransferPaymentMethodsCard withDomesticPushToCard(Optional<? extends DomesticPushToCard> domesticPushToCard) {
        Utils.checkNotNull(domesticPushToCard, "domesticPushToCard");
        this.domesticPushToCard = domesticPushToCard;
        return this;
    }
     ...
     * Indicates if the card supports domestic pull-from-card transfer.
     */
    public TransferPaymentMethodsCard withDomesticPullFromCard(DomesticPullFromCard domesticPullFromCard) {
        Utils.checkNotNull(domesticPullFromCard, "domesticPullFromCard");
     ...
     * Indicates if the card supports domestic pull-from-card transfer.
     */
    public TransferPaymentMethodsCard withDomesticPullFromCard(Optional<? extends DomesticPullFromCard> domesticPullFromCard) {
        Utils.checkNotNull(domesticPullFromCard, "domesticPullFromCard");
        this.domesticPullFromCard = domesticPullFromCard;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransferPaymentMethodsCard other = (TransferPaymentMethodsCard) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransferPaymentMethodsCard.class,
                "cardID", cardID,
    ...
    public final static class Builder {
        ...
        public TransferPaymentMethodsCard build() {

            return new TransferPaymentMethodsCard(
                cardID, fingerprint, brand,
                cardType, lastFourCardNumber, bin,
                expiration, holderName, billingAddress,
                cardVerification, issuer, issuerCountry,
