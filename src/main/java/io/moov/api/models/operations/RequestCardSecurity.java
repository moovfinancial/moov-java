...
public class RequestCardSecurity {
    ...
    public RequestCardSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public RequestCardSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public RequestCardSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public RequestCardSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RequestCardSecurity other = (RequestCardSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RequestCardSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public RequestCardSecurity build() {
            return new RequestCardSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
