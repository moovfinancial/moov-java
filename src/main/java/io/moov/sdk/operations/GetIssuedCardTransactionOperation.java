...
public class GetIssuedCardTransactionOperation implements RequestOperation<GetIssuedCardTransactionRequest, GetIssuedCardTransactionResponse> {
    ...
    public GetIssuedCardTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetIssuedCardTransactionRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetIssuedCardTransactionRequest request) throws Exception {
    ...
    @Override
    public GetIssuedCardTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetIssuedCardTransactionResponse.Builder resBuilder = 
        ...
        GetIssuedCardTransactionResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                IssuedCardTransaction out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withIssuedCardTransaction(out);
                return res;
            } else {
