...
public class GetOnboardingInvite {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOnboardingInviteRequest request) {
        ...
        @Override
        public GetOnboardingInviteResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOnboardingInvite(Utils.unmarshal(response, new TypeReference<OnboardingInvite>() {}));
                } else {
