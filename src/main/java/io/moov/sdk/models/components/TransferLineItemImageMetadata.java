...
public class TransferLineItemImageMetadata {
    /**
    ...
    @JsonCreator
    public TransferLineItemImageMetadata(
     ...
     * Unique identifier for a image resource.
     */
    public TransferLineItemImageMetadata withImageID(String imageID) {
        Utils.checkNotNull(imageID, "imageID");
        this.imageID = imageID;
        return this;
    }
     ...
     * Alternative text for the image.
     */
    public TransferLineItemImageMetadata withAltText(String altText) {
        Utils.checkNotNull(altText, "altText");
     ...
     * Alternative text for the image.
     */
    public TransferLineItemImageMetadata withAltText(Optional<String> altText) {
        Utils.checkNotNull(altText, "altText");
        this.altText = altText;
        return this;
    }
     ...
     * The image's public URL.
     */
    public TransferLineItemImageMetadata withLink(String link) {
        Utils.checkNotNull(link, "link");
        this.link = link;
        return this;
    }
     ...
     * A unique identifier for an image, used in public image links.
     */
    public TransferLineItemImageMetadata withPublicID(String publicID) {
        Utils.checkNotNull(publicID, "publicID");
        this.publicID = publicID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransferLineItemImageMetadata other = (TransferLineItemImageMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransferLineItemImageMetadata.class,
                "imageID", imageID,
                "altText", altText,
                "link", link,
                "publicID", publicID);
    ...
    public final static class Builder {
        ...
        public TransferLineItemImageMetadata build() {

            return new TransferLineItemImageMetadata(
                imageID, altText, link,
                publicID);
        }
