...
public class GetDisputeEvidenceSecurity {
    ...
    @JsonCreator
    public GetDisputeEvidenceSecurity(
    ...
    public GetDisputeEvidenceSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetDisputeEvidenceSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetDisputeEvidenceSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetDisputeEvidenceSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDisputeEvidenceSecurity other = (GetDisputeEvidenceSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetDisputeEvidenceSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetDisputeEvidenceSecurity build() {
            return new GetDisputeEvidenceSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
