...
public class GetFullIssuedCardSecurity {
    ...
    @JsonCreator
    public GetFullIssuedCardSecurity(
    ...
    public GetFullIssuedCardSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetFullIssuedCardSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetFullIssuedCardSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetFullIssuedCardSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFullIssuedCardSecurity other = (GetFullIssuedCardSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFullIssuedCardSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetFullIssuedCardSecurity build() {
            return new GetFullIssuedCardSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
