...
public class RegisterApplePayMerchantDomainsOperation implements RequestOperation<RegisterApplePayMerchantDomainsRequest, RegisterApplePayMerchantDomainsResponse> {
    ...
    public RegisterApplePayMerchantDomainsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RegisterApplePayMerchantDomainsRequest request) throws Exception {
