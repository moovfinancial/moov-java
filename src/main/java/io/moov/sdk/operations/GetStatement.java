...
public class GetStatement {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStatementRequest, GetStatementResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetStatementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStatementRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStatementRequest request) throws Exception {
        ...
        @Override
        public GetStatementResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetStatementResponse.Builder resBuilder =
            ...
            GetStatementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Statement out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withStatement(out);
                    return res;
