...
public class CancelScheduleSecurity {
    ...
    public CancelScheduleSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CancelScheduleSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CancelScheduleSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CancelScheduleSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelScheduleSecurity other = (CancelScheduleSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelScheduleSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CancelScheduleSecurity build() {
            return new CancelScheduleSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
