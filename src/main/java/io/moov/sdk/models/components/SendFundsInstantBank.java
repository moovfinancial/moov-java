...
public class SendFundsInstantBank {
    ...
    public SendFundsInstantBank withEstimatedActivity(EstimatedActivity estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
    ...
    public SendFundsInstantBank withEstimatedActivity(Optional<? extends EstimatedActivity> estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
        this.estimatedActivity = estimatedActivity;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SendFundsInstantBank other = (SendFundsInstantBank) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SendFundsInstantBank.class,
    ...
    public final static class Builder {
        ...
        public SendFundsInstantBank build() {

            return new SendFundsInstantBank(
                estimatedActivity);
        }
