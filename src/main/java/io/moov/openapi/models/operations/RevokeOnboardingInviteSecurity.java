...
public class RevokeOnboardingInviteSecurity {
    ...
    @JsonCreator
    public RevokeOnboardingInviteSecurity(
    ...
    public RevokeOnboardingInviteSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public RevokeOnboardingInviteSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public RevokeOnboardingInviteSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public RevokeOnboardingInviteSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RevokeOnboardingInviteSecurity other = (RevokeOnboardingInviteSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RevokeOnboardingInviteSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public RevokeOnboardingInviteSecurity build() {
            return new RevokeOnboardingInviteSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
