...
public class ListWalletsOperation implements RequestOperation<ListWalletsRequest, ListWalletsResponse> {
    ...
    public ListWalletsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListWalletsRequest request) throws Exception {
    ...
    public ListWalletsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            ...
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<Wallet> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withWallets(out);
