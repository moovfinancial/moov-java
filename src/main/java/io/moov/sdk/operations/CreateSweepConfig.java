...
public class CreateSweepConfig {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSweepConfigRequest, CreateSweepConfigResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(CreateSweepConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSweepConfigRequest.class, new TypeReference<CreateSweepConfigRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSweepConfigRequest request) throws Exception {
        ...
        @Override
        public CreateSweepConfigResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSweepConfigResponse.Builder resBuilder =
            ...
            CreateSweepConfigResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SweepConfig out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSweepConfig(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateSweepConfigError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
