...
public class CreateCapture {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCaptureRequest, CreateCaptureResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCaptureRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCaptureRequest.class, new TypeReference<CreateCaptureRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCaptureRequest request) {
        ...
        @Override
        public CreateCaptureResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCaptureResponse.Builder resBuilder =
            ...
            CreateCaptureResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCapture(Utils.unmarshal(response, new TypeReference<Capture>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CaptureValidationError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
