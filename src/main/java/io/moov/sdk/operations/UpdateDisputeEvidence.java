...
public class UpdateDisputeEvidence {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDisputeEvidenceRequest request) {
        ...
        @Override
        public UpdateDisputeEvidenceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDisputeEvidenceResponse(Utils.unmarshal(response, new TypeReference<DisputeEvidenceResponse>() {}));
                } else {
