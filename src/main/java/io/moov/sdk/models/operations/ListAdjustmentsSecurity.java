...
public class ListAdjustmentsSecurity {
    ...
    @JsonCreator
    public ListAdjustmentsSecurity(
    ...
    public ListAdjustmentsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListAdjustmentsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListAdjustmentsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListAdjustmentsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAdjustmentsSecurity other = (ListAdjustmentsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAdjustmentsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListAdjustmentsSecurity build() {
            return new ListAdjustmentsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
