...
public class GetTermsOfServiceToken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTermsOfServiceTokenRequest request) {
        ...
        @Override
        public GetTermsOfServiceTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTermsOfServiceToken(Utils.unmarshal(response, new TypeReference<TermsOfServiceToken>() {}));
                } else {
