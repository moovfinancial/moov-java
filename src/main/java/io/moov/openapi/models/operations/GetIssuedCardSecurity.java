...
public class GetIssuedCardSecurity {
    ...
    public GetIssuedCardSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetIssuedCardSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetIssuedCardSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetIssuedCardSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetIssuedCardSecurity other = (GetIssuedCardSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetIssuedCardSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetIssuedCardSecurity build() {
            return new GetIssuedCardSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
