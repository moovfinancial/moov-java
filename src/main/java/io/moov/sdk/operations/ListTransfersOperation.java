...
public class ListTransfersOperation implements RequestOperation<ListTransfersRequest, ListTransfersResponse> {
    ...
    public ListTransfersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTransfersRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListTransfersRequest request) throws Exception {
    ...
    @Override
    public ListTransfersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            ...
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<Transfer> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
