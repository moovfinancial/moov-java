...
public class UploadDisputeEvidenceTextSecurity {
    ...
    @JsonCreator
    public UploadDisputeEvidenceTextSecurity(
    ...
    public UploadDisputeEvidenceTextSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UploadDisputeEvidenceTextSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UploadDisputeEvidenceTextSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UploadDisputeEvidenceTextSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UploadDisputeEvidenceTextSecurity other = (UploadDisputeEvidenceTextSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UploadDisputeEvidenceTextSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UploadDisputeEvidenceTextSecurity build() {
            return new UploadDisputeEvidenceTextSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
