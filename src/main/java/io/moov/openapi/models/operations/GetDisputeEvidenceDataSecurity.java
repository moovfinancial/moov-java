...
public class GetDisputeEvidenceDataSecurity {
    ...
    @JsonCreator
    public GetDisputeEvidenceDataSecurity(
    ...
    public GetDisputeEvidenceDataSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetDisputeEvidenceDataSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetDisputeEvidenceDataSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetDisputeEvidenceDataSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDisputeEvidenceDataSecurity other = (GetDisputeEvidenceDataSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetDisputeEvidenceDataSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetDisputeEvidenceDataSecurity build() {
            return new GetDisputeEvidenceDataSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
