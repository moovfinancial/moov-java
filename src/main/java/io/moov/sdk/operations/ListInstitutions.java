...
public class ListInstitutions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInstitutionsRequest request) {
        ...
        @Override
        public ListInstitutionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFinancialInstitutions(Utils.unmarshal(response, new TypeReference<FinancialInstitutions>() {}));
                } else {
