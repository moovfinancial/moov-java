...
public class CreateReversalOperation implements RequestOperation<CreateReversalRequest, CreateReversalResponse> {
    ...
    public CreateReversalOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateReversalRequest request) throws Exception {
