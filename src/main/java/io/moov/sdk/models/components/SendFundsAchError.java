...
public class SendFundsAchError {
    ...
    public SendFundsAchError withEstimatedActivity(EstimatedActivityError estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
    ...
    public SendFundsAchError withEstimatedActivity(Optional<? extends EstimatedActivityError> estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
        this.estimatedActivity = estimatedActivity;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SendFundsAchError other = (SendFundsAchError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SendFundsAchError.class,
    ...
    public final static class Builder {
        ...
        public SendFundsAchError build() {

            return new SendFundsAchError(
                estimatedActivity);
        }
