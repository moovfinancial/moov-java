...
public class RequestCapabilitiesSecurity {
    ...
    @JsonCreator
    public RequestCapabilitiesSecurity(
    ...
    public RequestCapabilitiesSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public RequestCapabilitiesSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public RequestCapabilitiesSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public RequestCapabilitiesSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RequestCapabilitiesSecurity other = (RequestCapabilitiesSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RequestCapabilitiesSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public RequestCapabilitiesSecurity build() {
            return new RequestCapabilitiesSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
