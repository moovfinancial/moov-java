...
public class UploadFileSecurity {
    ...
    public UploadFileSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UploadFileSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UploadFileSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UploadFileSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UploadFileSecurity other = (UploadFileSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UploadFileSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UploadFileSecurity build() {
            return new UploadFileSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
