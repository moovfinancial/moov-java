...
public class ListOnboardingInvitesSecurity {
    ...
    @JsonCreator
    public ListOnboardingInvitesSecurity(
    ...
    public ListOnboardingInvitesSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListOnboardingInvitesSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListOnboardingInvitesSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListOnboardingInvitesSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListOnboardingInvitesSecurity other = (ListOnboardingInvitesSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListOnboardingInvitesSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListOnboardingInvitesSecurity build() {
            return new ListOnboardingInvitesSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
