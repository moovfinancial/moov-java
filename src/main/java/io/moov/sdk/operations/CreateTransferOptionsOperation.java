...
public class CreateTransferOptionsOperation implements RequestOperation<CreateTransferOptionsRequest, CreateTransferOptionsResponse> {
    ...
    public CreateTransferOptionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTransferOptionsRequest request) throws Exception {
