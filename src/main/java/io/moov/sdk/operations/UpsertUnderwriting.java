...
public class UpsertUnderwriting {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpsertUnderwritingRequest, UpsertUnderwritingResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(UpsertUnderwritingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpsertUnderwritingRequest.class, new TypeReference<UpsertUnderwritingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpsertUnderwritingRequest request) throws Exception {
        ...
        @Override
        public UpsertUnderwritingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpsertUnderwritingResponse.Builder resBuilder =
            ...
            UpsertUnderwritingResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateUnderwritingError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
