...
public class GetEnrichmentProfileSecurity {
    ...
    @JsonCreator
    public GetEnrichmentProfileSecurity(
    ...
    public GetEnrichmentProfileSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetEnrichmentProfileSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetEnrichmentProfileSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetEnrichmentProfileSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEnrichmentProfileSecurity other = (GetEnrichmentProfileSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEnrichmentProfileSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetEnrichmentProfileSecurity build() {
            return new GetEnrichmentProfileSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
