...
public class CreateReceiptsRequest {
    ...
    @JsonCreator
    public CreateReceiptsRequest(
            Optional<String> xMoovVersion,
            List<ReceiptRequest> requestBody) {
     ...
     * <p>The `latest` version represents the most recent development state. It may include breaking changes and should be treated as a beta release.
     */
    public CreateReceiptsRequest withXMoovVersion(String xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
     ...
     * <p>The `latest` version represents the most recent development state. It may include breaking changes and should be treated as a beta release.
     */
    public CreateReceiptsRequest withXMoovVersion(Optional<String> xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
        this.xMoovVersion = xMoovVersion;
        return this;
    }

    public CreateReceiptsRequest withRequestBody(List<ReceiptRequest> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateReceiptsRequest other = (CreateReceiptsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateReceiptsRequest.class,
    ...
    public final static class Builder {
        ...
        public Builder requestBody(List<ReceiptRequest> requestBody) {
            Utils.checkNotNull(requestBody, "requestBody");
            this.requestBody = requestBody;
            return this;
        }
        ...
        public CreateReceiptsRequest build() {
            ...
            }            return new CreateReceiptsRequest(
                xMoovVersion,
                requestBody);
        }
