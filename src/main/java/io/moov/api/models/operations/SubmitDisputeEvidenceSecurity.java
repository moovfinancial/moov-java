...
public class SubmitDisputeEvidenceSecurity {
    ...
    @JsonCreator
    public SubmitDisputeEvidenceSecurity(
    ...
    public SubmitDisputeEvidenceSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public SubmitDisputeEvidenceSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public SubmitDisputeEvidenceSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public SubmitDisputeEvidenceSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SubmitDisputeEvidenceSecurity other = (SubmitDisputeEvidenceSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SubmitDisputeEvidenceSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public SubmitDisputeEvidenceSecurity build() {
            return new SubmitDisputeEvidenceSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
