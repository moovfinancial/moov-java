...
public class UpdateScheduleOperation implements RequestOperation<UpdateScheduleRequest, UpdateScheduleResponse> {
    ...
    public UpdateScheduleOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateScheduleRequest request) throws Exception {
