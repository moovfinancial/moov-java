...
public class GetWalletTransaction {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWalletTransactionRequest request) {
        ...
        @Override
        public GetWalletTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWalletTransaction(Utils.unmarshal(response, new TypeReference<WalletTransaction>() {}));
                } else {
