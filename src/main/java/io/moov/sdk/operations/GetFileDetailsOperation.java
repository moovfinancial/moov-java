...
public class GetFileDetailsOperation implements RequestOperation<GetFileDetailsRequest, GetFileDetailsResponse> {
    ...
    public GetFileDetailsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetFileDetailsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetFileDetailsRequest request) throws Exception {
    ...
    @Override
    public GetFileDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetFileDetailsResponse.Builder resBuilder = 
        ...
        GetFileDetailsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                FileDetails out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withFileDetails(out);
                return res;
            } else {
