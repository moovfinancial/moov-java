...
public class ListResiduals {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListResidualsRequest, ListResidualsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListResidualsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListResidualsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListResidualsRequest request) {
        ...
        @Override
        public ListResidualsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListResidualsResponse.Builder resBuilder =
            ...
            ListResidualsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResiduals(Utils.unmarshal(response, new TypeReference<List<Residual>>() {}));
                } else {
