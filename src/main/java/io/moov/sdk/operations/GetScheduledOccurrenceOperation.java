...
public class GetScheduledOccurrenceOperation implements RequestOperation<GetScheduledOccurrenceRequest, GetScheduledOccurrenceResponse> {
    ...
    public GetScheduledOccurrenceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetScheduledOccurrenceRequest request) throws Exception {
