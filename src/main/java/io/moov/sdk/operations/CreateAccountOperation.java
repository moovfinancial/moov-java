...
public class CreateAccountOperation implements RequestOperation<CreateAccount, CreateAccountResponse> {
    ...
    public CreateAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccount request) throws Exception {
        ...
        Object convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<CreateAccount>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreateAccount request) throws Exception {
