...
public class ListAccountsOperation implements RequestOperation<ListAccountsRequest, ListAccountsResponse> {
    ...
    public ListAccountsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountsRequest request) throws Exception {
    ...
    public ListAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            ...
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<Account> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withAccounts(out);
                return res;
            } else {
