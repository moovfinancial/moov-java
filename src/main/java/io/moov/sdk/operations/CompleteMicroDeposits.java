...
public class CompleteMicroDeposits {
    ...
    public static class Sync extends Base
            implements RequestOperation<CompleteMicroDepositsRequest, CompleteMicroDepositsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CompleteMicroDepositsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CompleteMicroDepositsRequest.class, new TypeReference<CompleteMicroDepositsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CompleteMicroDepositsRequest request) throws Exception {
        ...
        @Override
        public CompleteMicroDepositsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CompleteMicroDepositsResponse.Builder resBuilder =
            ...
            CompleteMicroDepositsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompletedMicroDeposits out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompletedMicroDeposits(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MicroDepositValidationError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
