...
public class UpdateTransferConfig {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTransferConfigRequest, UpdateTransferConfigResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTransferConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTransferConfigRequest.class, new TypeReference<UpdateTransferConfigRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTransferConfigRequest request) {
        ...
        @Override
        public UpdateTransferConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTransferConfigResponse.Builder resBuilder =
            ...
            UpdateTransferConfigResponse res = resBuilder.build();
