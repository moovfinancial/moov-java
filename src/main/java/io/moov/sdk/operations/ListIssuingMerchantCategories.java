...
public class ListIssuingMerchantCategories {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListIssuingMerchantCategoriesResponse> {
        ...
        @Override
        public ListIssuingMerchantCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListIssuingMerchantCategoriesResponse.Builder resBuilder =
            ...
            ListIssuingMerchantCategoriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMerchantCategories(Utils.unmarshal(response, new TypeReference<MerchantCategories>() {}));
                } else {
