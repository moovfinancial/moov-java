...
public class GetTerminalApplicationResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetTerminalApplicationResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetTerminalApplicationResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetTerminalApplicationResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetTerminalApplicationResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The request completed successfully.
     */
    public GetTerminalApplicationResponse withTerminalApplication(TerminalApplication terminalApplication) {
        Utils.checkNotNull(terminalApplication, "terminalApplication");
     ...
     * The request completed successfully.
     */
    public GetTerminalApplicationResponse withTerminalApplication(Optional<? extends TerminalApplication> terminalApplication) {
        Utils.checkNotNull(terminalApplication, "terminalApplication");
        this.terminalApplication = terminalApplication;
        return this;
    }

    public GetTerminalApplicationResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTerminalApplicationResponse other = (GetTerminalApplicationResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTerminalApplicationResponse.class,
    ...
    public final static class Builder {
        ...
        public GetTerminalApplicationResponse build() {

            return new GetTerminalApplicationResponse(
                contentType, statusCode, rawResponse,
                terminalApplication, headers);
        }
