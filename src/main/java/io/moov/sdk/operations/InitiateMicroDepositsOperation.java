...
public class InitiateMicroDepositsOperation implements RequestOperation<InitiateMicroDepositsRequest, InitiateMicroDepositsResponse> {
    ...
    public InitiateMicroDepositsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(InitiateMicroDepositsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(InitiateMicroDepositsRequest request) throws Exception {
    ...
    @Override
    public InitiateMicroDepositsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
