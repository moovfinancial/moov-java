...
public class GetAccountCountriesOperation implements RequestOperation<GetAccountCountriesRequest, GetAccountCountriesResponse> {
    ...
    public GetAccountCountriesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountCountriesRequest request) throws Exception {
