...
public class ListSweepConfigsSecurity {
    ...
    @JsonCreator
    public ListSweepConfigsSecurity(
    ...
    public ListSweepConfigsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListSweepConfigsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListSweepConfigsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListSweepConfigsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSweepConfigsSecurity other = (ListSweepConfigsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSweepConfigsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListSweepConfigsSecurity build() {
            return new ListSweepConfigsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
