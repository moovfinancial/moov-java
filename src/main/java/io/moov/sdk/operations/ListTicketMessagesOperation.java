...
public class ListTicketMessagesOperation implements RequestOperation<ListTicketMessagesRequest, ListTicketMessagesResponse> {
    ...
    public ListTicketMessagesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTicketMessagesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListTicketMessagesRequest request) throws Exception {
    ...
    @Override
    public ListTicketMessagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListTicketMessagesResponse.Builder resBuilder = 
        ...
        ListTicketMessagesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<TicketMessage> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withTicketMessages(out);
                return res;
            } else {
