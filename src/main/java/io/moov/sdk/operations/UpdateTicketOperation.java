...
public class UpdateTicketOperation implements RequestOperation<UpdateTicketRequest, UpdateTicketResponse> {
    ...
    public UpdateTicketOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateTicketRequest request) throws Exception {
