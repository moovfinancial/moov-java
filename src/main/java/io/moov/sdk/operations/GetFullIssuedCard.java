...
public class GetFullIssuedCard {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetFullIssuedCardRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFullIssuedCardRequest, GetFullIssuedCardResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetFullIssuedCardRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFullIssuedCardRequest request) throws Exception {
        ...
        @Override
        public GetFullIssuedCardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFullIssuedCardResponse.Builder resBuilder =
            ...
            GetFullIssuedCardResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FullIssuedCard out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFullIssuedCard(out);
                    return res;
                } else {
