...
public class DisableBankAccount {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DisableBankAccountRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableBankAccountRequest, DisableBankAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DisableBankAccountRequest request) throws Exception {
