...
public class ListCaptures {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCapturesRequest, ListCapturesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCapturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCapturesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCapturesRequest request) {
        ...
        @Override
        public ListCapturesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCapturesResponse.Builder resBuilder =
            ...
            ListCapturesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCaptures(Utils.unmarshal(response, new TypeReference<List<Capture>>() {}));
                } else {
