...
public class ListAccountTerminalApplications {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountTerminalApplicationsRequest, ListAccountTerminalApplicationsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountTerminalApplicationsRequest request) {
        ...
        @Override
        public ListAccountTerminalApplicationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountTerminalApplications(Utils.unmarshal(response, new TypeReference<List<AccountTerminalApplication>>() {}));
                } else {
