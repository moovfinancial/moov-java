...
public class GetRepresentativeSecurity {
    ...
    @JsonCreator
    public GetRepresentativeSecurity(
    ...
    public GetRepresentativeSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetRepresentativeSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetRepresentativeSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetRepresentativeSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRepresentativeSecurity other = (GetRepresentativeSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRepresentativeSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetRepresentativeSecurity build() {
            return new GetRepresentativeSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
