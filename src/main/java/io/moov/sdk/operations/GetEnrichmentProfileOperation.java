...
public class GetEnrichmentProfileOperation implements RequestOperation<GetEnrichmentProfileRequest, GetEnrichmentProfileResponse> {
    ...
    public GetEnrichmentProfileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetEnrichmentProfileRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetEnrichmentProfileRequest request) throws Exception {
    ...
    @Override
    public GetEnrichmentProfileResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetEnrichmentProfileResponse.Builder resBuilder = 
        ...
        GetEnrichmentProfileResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                EnrichedBusinessResponse out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withEnrichedBusinessResponse(out);
                return res;
            } else {
