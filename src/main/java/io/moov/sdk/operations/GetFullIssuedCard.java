...
public class GetFullIssuedCard {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFullIssuedCardRequest request) {
        ...
        @Override
        public GetFullIssuedCardResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFullIssuedCard(Utils.unmarshal(response, new TypeReference<FullIssuedCard>() {}));
                } else {
