...
import io.moov.sdk.Moov;
import io.moov.sdk.models.components.ACHPaymentSettingsUpdate;
import io.moov.sdk.models.components.AccountType;
import io.moov.sdk.models.components.AddressUpdate;
import io.moov.sdk.models.components.BirthDateUpdate;
import io.moov.sdk.models.components.BusinessType;
import io.moov.sdk.models.components.CardPaymentSettings;
import io.moov.sdk.models.components.CreateAccountUpdate;
import io.moov.sdk.models.components.CreateAccountUpdateTermsOfService;
import io.moov.sdk.models.components.CreateBusinessProfileUpdate;
import io.moov.sdk.models.components.CreateIndividualProfileUpdate;
import io.moov.sdk.models.components.CreateProfileUpdate;
import io.moov.sdk.models.components.CustomerSupportUpdate;
import io.moov.sdk.models.components.IndividualNameUpdate;
import io.moov.sdk.models.components.IndustryCodes;
import io.moov.sdk.models.components.ManualTermsOfServiceUpdate;
import io.moov.sdk.models.components.PhoneNumber;
import io.moov.sdk.models.components.Security;
import io.moov.sdk.models.components.SettingsUpdate;
        ...
        UpdateAccountResponse res = sdk.accounts().update()
                ...
                .createAccountUpdate(CreateAccountUpdate.builder()
                    ...
                    .profile(CreateProfileUpdate.builder()
                        .individual(CreateIndividualProfileUpdate.builder()
                    ...
                    .metadata(Map.ofEntries(
                        Map.entry("optional", "metadata")))
                    .termsOfService(CreateAccountUpdateTermsOfService.of(ManualTermsOfServiceUpdate.builder()
                        ...
                        .build()))
                    .customerSupport(CustomerSupportUpdate.builder()
                        .phone(PhoneNumber.builder()
                            .number("8185551212")
                            .countryCode("1")
                            .build())
                        ...
                        .address(AddressUpdate.builder()
                            ...
                            .build())
                        .build())
                    .settings(SettingsUpdate.builder()
                        .cardPayment(CardPaymentSettings.builder()
                            .statementDescriptor("Whole Body Fitness")
                            .build())
                        .achPayment(ACHPaymentSettingsUpdate.builder()
                            .companyName("WholeBodyFitness")
                            .build())
                        .build())
                    .build())
