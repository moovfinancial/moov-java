...
public class ListAdjustments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdjustmentsRequest request) {
        ...
        @Override
        public ListAdjustmentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdjustments(Utils.unmarshal(response, new TypeReference<List<Adjustment>>() {}));
                } else {
