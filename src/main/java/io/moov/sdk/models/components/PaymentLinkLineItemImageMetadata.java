...
public class PaymentLinkLineItemImageMetadata {
    /**
    ...
    @JsonCreator
    public PaymentLinkLineItemImageMetadata(
     ...
     * Unique identifier for a image resource.
     */
    public PaymentLinkLineItemImageMetadata withImageID(String imageID) {
        Utils.checkNotNull(imageID, "imageID");
        this.imageID = imageID;
        return this;
    }
     ...
     * Alternative text for the image.
     */
    public PaymentLinkLineItemImageMetadata withAltText(String altText) {
        Utils.checkNotNull(altText, "altText");
     ...
     * Alternative text for the image.
     */
    public PaymentLinkLineItemImageMetadata withAltText(Optional<String> altText) {
        Utils.checkNotNull(altText, "altText");
        this.altText = altText;
        return this;
    }
     ...
     * The image's public URL.
     */
    public PaymentLinkLineItemImageMetadata withLink(String link) {
        Utils.checkNotNull(link, "link");
        this.link = link;
        return this;
    }
     ...
     * A unique identifier for an image, used in public image links.
     */
    public PaymentLinkLineItemImageMetadata withPublicID(String publicID) {
        Utils.checkNotNull(publicID, "publicID");
        this.publicID = publicID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentLinkLineItemImageMetadata other = (PaymentLinkLineItemImageMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaymentLinkLineItemImageMetadata.class,
                "imageID", imageID,
                "altText", altText,
                "link", link,
                "publicID", publicID);
    ...
    public final static class Builder {
        ...
        public PaymentLinkLineItemImageMetadata build() {

            return new PaymentLinkLineItemImageMetadata(
                imageID, altText, link,
                publicID);
        }
