...
import io.moov.api.models.components.Capability;
...
public class AddCapabilitiesResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public AddCapabilitiesResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public AddCapabilitiesResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AddCapabilitiesResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The request completed successfully.
     */
    public AddCapabilitiesResponse withCapabilities(List<Capability> capabilities) {
        Utils.checkNotNull(capabilities, "capabilities");
     ...
     * The request completed successfully.
     */
    public AddCapabilitiesResponse withCapabilities(Optional<? extends List<Capability>> capabilities) {
        Utils.checkNotNull(capabilities, "capabilities");
        this.capabilities = capabilities;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddCapabilitiesResponse other = (AddCapabilitiesResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddCapabilitiesResponse.class,
    ...
    public final static class Builder {
        ...
        public AddCapabilitiesResponse build() {
