...
public class AcceptDispute {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AcceptDisputeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AcceptDisputeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AcceptDisputeRequest request) {
        ...
        @Override
        public AcceptDisputeResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDispute(Utils.unmarshal(response, new TypeReference<Dispute>() {}));
                } else {
