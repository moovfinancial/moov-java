...
public class DisableResolutionLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableResolutionLinkRequest, DisableResolutionLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DisableResolutionLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableResolutionLinkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisableResolutionLinkRequest request) {
        ...
        @Override
        public DisableResolutionLinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisableResolutionLinkResponse.Builder resBuilder =
            ...
            DisableResolutionLinkResponse res = resBuilder.build();
