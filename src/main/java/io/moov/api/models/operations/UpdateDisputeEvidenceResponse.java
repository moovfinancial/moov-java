...
public class UpdateDisputeEvidenceResponse implements Response {
     ...
     * The request completed successfully.
     */
    public UpdateDisputeEvidenceResponse withDisputeEvidenceMetadata(DisputeEvidenceMetadata disputeEvidenceMetadata) {
        Utils.checkNotNull(disputeEvidenceMetadata, "disputeEvidenceMetadata");
     ...
     * The request completed successfully.
     */
    public UpdateDisputeEvidenceResponse withDisputeEvidenceMetadata(Optional<? extends DisputeEvidenceMetadata> disputeEvidenceMetadata) {
        Utils.checkNotNull(disputeEvidenceMetadata, "disputeEvidenceMetadata");
        this.disputeEvidenceMetadata = disputeEvidenceMetadata;
        return this;
    }
