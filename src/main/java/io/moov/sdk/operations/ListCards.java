...
public class ListCards {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListCardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCardsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCardsRequest request) {
        ...
        @Override
        public ListCardsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCards(Utils.unmarshal(response, new TypeReference<List<Card>>() {}));
                } else {
