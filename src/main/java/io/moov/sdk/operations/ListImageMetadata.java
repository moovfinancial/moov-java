...
public class ListImageMetadata {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListImageMetadataRequest request) {
        ...
        @Override
        public ListImageMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withImageMetadata(Utils.unmarshal(response, new TypeReference<List<ImageMetadata>>() {}));
                } else {
