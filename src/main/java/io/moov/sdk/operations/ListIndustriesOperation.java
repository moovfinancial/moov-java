...
public class ListIndustriesOperation implements RequestOperation<ListIndustriesRequest, ListIndustriesResponse> {
    ...
    public ListIndustriesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListIndustriesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListIndustriesRequest request) throws Exception {
    ...
    @Override
    public ListIndustriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListIndustriesResponse.Builder resBuilder = 
        ...
        ListIndustriesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                EnrichedIndustries out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withEnrichedIndustries(out);
                return res;
            } else {
