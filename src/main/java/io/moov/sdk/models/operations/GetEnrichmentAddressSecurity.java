...
public class GetEnrichmentAddressSecurity {
    ...
    @JsonCreator
    public GetEnrichmentAddressSecurity(
    ...
    public GetEnrichmentAddressSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetEnrichmentAddressSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetEnrichmentAddressSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetEnrichmentAddressSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEnrichmentAddressSecurity other = (GetEnrichmentAddressSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEnrichmentAddressSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetEnrichmentAddressSecurity build() {
            return new GetEnrichmentAddressSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
