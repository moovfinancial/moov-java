...
public class UpdateAccountSecurity {
    ...
    public UpdateAccountSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdateAccountSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdateAccountSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdateAccountSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateAccountSecurity other = (UpdateAccountSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateAccountSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdateAccountSecurity build() {
            return new UpdateAccountSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
