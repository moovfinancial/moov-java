...
public class CreateOnboardingInviteSecurity {
    ...
    @JsonCreator
    public CreateOnboardingInviteSecurity(
    ...
    public CreateOnboardingInviteSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CreateOnboardingInviteSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CreateOnboardingInviteSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CreateOnboardingInviteSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateOnboardingInviteSecurity other = (CreateOnboardingInviteSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateOnboardingInviteSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CreateOnboardingInviteSecurity build() {
            return new CreateOnboardingInviteSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
