...
public class ListDisputeEvidenceOperation implements RequestOperation<ListDisputeEvidenceRequest, ListDisputeEvidenceResponse> {
    ...
    public ListDisputeEvidenceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListDisputeEvidenceRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListDisputeEvidenceRequest request) throws Exception {
    ...
    @Override
    public ListDisputeEvidenceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListDisputeEvidenceResponse.Builder resBuilder = 
        ...
        ListDisputeEvidenceResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<DisputeEvidenceResponse> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withDisputeEvidenceResponses(out);
                return res;
            } else {
