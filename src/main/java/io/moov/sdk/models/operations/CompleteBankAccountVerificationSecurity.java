...
public class CompleteBankAccountVerificationSecurity {
    ...
    @JsonCreator
    public CompleteBankAccountVerificationSecurity(
    ...
    public CompleteBankAccountVerificationSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CompleteBankAccountVerificationSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CompleteBankAccountVerificationSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CompleteBankAccountVerificationSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CompleteBankAccountVerificationSecurity other = (CompleteBankAccountVerificationSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CompleteBankAccountVerificationSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CompleteBankAccountVerificationSecurity build() {
            return new CompleteBankAccountVerificationSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
