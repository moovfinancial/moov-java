...
public class UpdateAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountRequest, UpdateAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountRequest.class, new TypeReference<UpdateAccountRequest>() {});
        ...
        public UpdateAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PatchAccountError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
