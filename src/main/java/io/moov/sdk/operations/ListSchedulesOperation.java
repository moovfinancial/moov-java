...
public class ListSchedulesOperation implements RequestOperation<ListSchedulesRequest, ListSchedulesResponse> {
    ...
    public ListSchedulesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListSchedulesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListSchedulesRequest request) throws Exception {
    ...
    @Override
    public ListSchedulesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListSchedulesResponse.Builder resBuilder = 
        ...
        ListSchedulesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<ScheduleListResponse> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withScheduleListResponses(out);
                return res;
            } else {
