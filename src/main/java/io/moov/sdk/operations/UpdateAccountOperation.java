...
public class UpdateAccountOperation implements RequestOperation<UpdateAccountRequest, UpdateAccountResponse> {
    ...
    public UpdateAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(UpdateAccountRequest request) throws Exception {
    ...
    @Override
    public UpdateAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        UpdateAccountResponse.Builder resBuilder = 
        ...
        UpdateAccountResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                Account out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withAccount(out);
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                UpdateAccountResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
