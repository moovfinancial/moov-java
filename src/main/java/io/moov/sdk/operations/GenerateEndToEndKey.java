...
public class GenerateEndToEndKey {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GenerateEndToEndKeyRequest request) {
        ...
        @Override
        public GenerateEndToEndKeyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withJSONWebKey(Utils.unmarshal(response, new TypeReference<JSONWebKey>() {}));
                } else {
