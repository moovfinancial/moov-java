...
public class GenerateEndToEndKey {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GenerateEndToEndKeyRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GenerateEndToEndKeyRequest, GenerateEndToEndKeyResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GenerateEndToEndKeyRequest request) throws Exception {
