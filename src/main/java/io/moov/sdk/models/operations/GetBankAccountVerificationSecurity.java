...
public class GetBankAccountVerificationSecurity {
    ...
    @JsonCreator
    public GetBankAccountVerificationSecurity(
    ...
    public GetBankAccountVerificationSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetBankAccountVerificationSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetBankAccountVerificationSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetBankAccountVerificationSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetBankAccountVerificationSecurity other = (GetBankAccountVerificationSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetBankAccountVerificationSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetBankAccountVerificationSecurity build() {
            return new GetBankAccountVerificationSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
