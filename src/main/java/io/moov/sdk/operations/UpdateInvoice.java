...
public class UpdateInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateInvoiceRequest, UpdateInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateInvoiceRequest.class, new TypeReference<UpdateInvoiceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateInvoiceRequest request) {
        ...
        @Override
        public UpdateInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateInvoiceResponse.Builder resBuilder =
            ...
            UpdateInvoiceResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw UpdateInvoiceError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
