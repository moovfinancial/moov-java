...
public class GetDisputeEvidence {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetDisputeEvidenceRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDisputeEvidenceRequest, GetDisputeEvidenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetDisputeEvidenceRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDisputeEvidenceRequest request) throws Exception {
        ...
        @Override
        public GetDisputeEvidenceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDisputeEvidenceResponse.Builder resBuilder =
            ...
            GetDisputeEvidenceResponse res = resBuilder.build();
