...
public class UpdateDisputeEvidenceResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public UpdateDisputeEvidenceResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public UpdateDisputeEvidenceResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateDisputeEvidenceResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The request completed successfully.
     */
    public UpdateDisputeEvidenceResponse withDisputeEvidenceResponse(DisputeEvidenceResponse disputeEvidenceResponse) {
        Utils.checkNotNull(disputeEvidenceResponse, "disputeEvidenceResponse");
     ...
     * The request completed successfully.
     */
    public UpdateDisputeEvidenceResponse withDisputeEvidenceResponse(Optional<? extends DisputeEvidenceResponse> disputeEvidenceResponse) {
        Utils.checkNotNull(disputeEvidenceResponse, "disputeEvidenceResponse");
        this.disputeEvidenceResponse = disputeEvidenceResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDisputeEvidenceResponse other = (UpdateDisputeEvidenceResponse) o;
        return 
            Utils.enhancedDeepEquals(this.contentType, other.contentType) &&
            Utils.enhancedDeepEquals(this.statusCode, other.statusCode) &&
            Utils.enhancedDeepEquals(this.rawResponse, other.rawResponse) &&
            Utils.enhancedDeepEquals(this.disputeEvidenceResponse, other.disputeEvidenceResponse) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            disputeEvidenceResponse, headers);
    }
    
    @Override
    public String toString() {
        return Utils.toString(UpdateDisputeEvidenceResponse.class,
