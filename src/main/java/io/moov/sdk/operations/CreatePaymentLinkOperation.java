...
public class CreatePaymentLinkOperation implements RequestOperation<CreatePaymentLinkRequest, CreatePaymentLinkResponse> {
    ...
    public CreatePaymentLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentLinkRequest request) throws Exception {
    ...
    @Override
    public CreatePaymentLinkResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreatePaymentLinkResponse.Builder resBuilder = 
        ...
        CreatePaymentLinkResponse res = resBuilder.build();
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                CreatePaymentLinkError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
