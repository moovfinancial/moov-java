...
public class ListInstitutionsOperation implements RequestOperation<ListInstitutionsRequest, ListInstitutionsResponse> {
    ...
    public ListInstitutionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListInstitutionsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListInstitutionsRequest request) throws Exception {
        HttpRequest r = buildRequest(request);
        HttpResponse<InputStream> httpRes;
        try {
            httpRes = client.send(r);
            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "429", "4XX", "500", "504", "5XX")) {
    ...
    @Override
    public ListInstitutionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListInstitutionsResponse.Builder resBuilder = 
        ...
        ListInstitutionsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                FinancialInstitutions out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withFinancialInstitutions(out);
                return res;
            } else {
