...
public class DisableBankAccountOperation implements RequestOperation<DisableBankAccountRequest, DisableBankAccountResponse> {
    ...
    public DisableBankAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DisableBankAccountRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DisableBankAccountRequest request) throws Exception {
    ...
    @Override
    public DisableBankAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DisableBankAccountResponse.Builder resBuilder = 
        ...
        DisableBankAccountResponse res = resBuilder.build();
