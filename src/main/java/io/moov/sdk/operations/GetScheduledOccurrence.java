...
public class GetScheduledOccurrence {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetScheduledOccurrenceRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetScheduledOccurrenceRequest, GetScheduledOccurrenceResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetScheduledOccurrenceRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetScheduledOccurrenceRequest request) throws Exception {
        ...
        @Override
        public GetScheduledOccurrenceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetScheduledOccurrenceResponse.Builder resBuilder =
            ...
            GetScheduledOccurrenceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OccurrencesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOccurrencesResponse(out);
                    return res;
                } else {
