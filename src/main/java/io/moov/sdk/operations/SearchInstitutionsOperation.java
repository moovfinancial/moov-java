...
public class SearchInstitutionsOperation implements RequestOperation<SearchInstitutionsRequest, SearchInstitutionsResponse> {
    ...
    public SearchInstitutionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(SearchInstitutionsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(SearchInstitutionsRequest request) throws Exception {
    ...
    @Override
    public SearchInstitutionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        SearchInstitutionsResponse.Builder resBuilder = 
        ...
        SearchInstitutionsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                InstitutionsSearchResponse out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withInstitutionsSearchResponse(out);
                return res;
            } else {
