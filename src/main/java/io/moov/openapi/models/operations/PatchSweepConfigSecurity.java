...
public class PatchSweepConfigSecurity {
    ...
    @JsonCreator
    public PatchSweepConfigSecurity(
    ...
    public PatchSweepConfigSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public PatchSweepConfigSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public PatchSweepConfigSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public PatchSweepConfigSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchSweepConfigSecurity other = (PatchSweepConfigSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchSweepConfigSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public PatchSweepConfigSecurity build() {
            return new PatchSweepConfigSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
