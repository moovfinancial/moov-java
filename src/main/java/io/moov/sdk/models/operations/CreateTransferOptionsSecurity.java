...
public class CreateTransferOptionsSecurity {
    ...
    @JsonCreator
    public CreateTransferOptionsSecurity(
    ...
    public CreateTransferOptionsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CreateTransferOptionsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CreateTransferOptionsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CreateTransferOptionsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateTransferOptionsSecurity other = (CreateTransferOptionsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateTransferOptionsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CreateTransferOptionsSecurity build() {
            return new CreateTransferOptionsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
