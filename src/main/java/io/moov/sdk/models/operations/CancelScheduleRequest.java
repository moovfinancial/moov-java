...
public class CancelScheduleRequest {
     ...
     * Specify an API version.
     */
    public CancelScheduleRequest withXMoovVersion(Versions xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
     ...
     * Specify an API version.
     */
    public CancelScheduleRequest withXMoovVersion(Optional<? extends Versions> xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
        this.xMoovVersion = xMoovVersion;
        return this;
    }
