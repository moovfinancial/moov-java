...
public class CreateAccountResponse implements Response {
     ...
     * The request completed successfully.
     */
    public CreateAccountResponse withAccount(Account account) {
        Utils.checkNotNull(account, "account");
     ...
     * The request completed successfully.
     */
    public CreateAccountResponse withAccount(Optional<? extends Account> account) {
        Utils.checkNotNull(account, "account");
        this.account = account;
        return this;
    }

    public CreateAccountResponse withHeaders(Map<String, List<String>> headers) {
