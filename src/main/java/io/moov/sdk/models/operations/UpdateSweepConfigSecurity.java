...
public class UpdateSweepConfigSecurity {
    ...
    @JsonCreator
    public UpdateSweepConfigSecurity(
    ...
    public UpdateSweepConfigSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdateSweepConfigSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdateSweepConfigSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdateSweepConfigSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateSweepConfigSecurity other = (UpdateSweepConfigSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateSweepConfigSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdateSweepConfigSecurity build() {
            return new UpdateSweepConfigSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
