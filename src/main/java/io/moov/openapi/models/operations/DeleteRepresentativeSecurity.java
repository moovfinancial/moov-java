...
public class DeleteRepresentativeSecurity {
    ...
    @JsonCreator
    public DeleteRepresentativeSecurity(
    ...
    public DeleteRepresentativeSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public DeleteRepresentativeSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public DeleteRepresentativeSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public DeleteRepresentativeSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteRepresentativeSecurity other = (DeleteRepresentativeSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteRepresentativeSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public DeleteRepresentativeSecurity build() {
            return new DeleteRepresentativeSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
