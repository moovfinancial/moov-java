...
public class RequestCardOperation implements RequestOperation<RequestCardRequest, RequestCardResponse> {
    ...
    public RequestCardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RequestCardRequest request) throws Exception {
