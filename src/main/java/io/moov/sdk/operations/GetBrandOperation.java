...
public class GetBrandOperation implements RequestOperation<GetBrandRequest, GetBrandResponse> {
    ...
    public GetBrandOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetBrandRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetBrandRequest request) throws Exception {
    ...
    @Override
    public GetBrandResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetBrandResponse.Builder resBuilder = 
            GetBrandResponse
                .builder()
        ...
        GetBrandResponse res = resBuilder.build();
