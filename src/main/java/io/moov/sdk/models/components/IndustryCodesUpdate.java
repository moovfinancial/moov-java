...
public class IndustryCodesUpdate {
    ...
    public IndustryCodesUpdate withNaics(String naics) {
        Utils.checkNotNull(naics, "naics");
        this.naics = Optional.ofNullable(naics);
        return this;
    }

    public IndustryCodesUpdate withNaics(Optional<String> naics) {
        Utils.checkNotNull(naics, "naics");
        this.naics = naics;
        return this;
    }

    public IndustryCodesUpdate withSic(String sic) {
        Utils.checkNotNull(sic, "sic");
        this.sic = Optional.ofNullable(sic);
        return this;
    }

    public IndustryCodesUpdate withSic(Optional<String> sic) {
        Utils.checkNotNull(sic, "sic");
        this.sic = sic;
        return this;
    }

    public IndustryCodesUpdate withMcc(String mcc) {
        Utils.checkNotNull(mcc, "mcc");
        this.mcc = Optional.ofNullable(mcc);
        return this;
    }

    public IndustryCodesUpdate withMcc(Optional<String> mcc) {
        Utils.checkNotNull(mcc, "mcc");
        this.mcc = mcc;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IndustryCodesUpdate other = (IndustryCodesUpdate) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IndustryCodesUpdate.class,
                "naics", naics,
                "sic", sic,
                "mcc", mcc);
    }
    ...
    public final static class Builder {
        ...
        public IndustryCodesUpdate build() {
            return new IndustryCodesUpdate(
                naics,
                sic,
                mcc);
        }
