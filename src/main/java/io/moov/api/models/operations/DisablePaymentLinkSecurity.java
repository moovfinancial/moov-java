...
public class DisablePaymentLinkSecurity {
    ...
    @JsonCreator
    public DisablePaymentLinkSecurity(
    ...
    public DisablePaymentLinkSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public DisablePaymentLinkSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public DisablePaymentLinkSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public DisablePaymentLinkSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DisablePaymentLinkSecurity other = (DisablePaymentLinkSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DisablePaymentLinkSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public DisablePaymentLinkSecurity build() {
            return new DisablePaymentLinkSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
