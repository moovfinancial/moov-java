...
public class GetCapability {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCapabilityRequest request) {
        ...
        @Override
        public GetCapabilityResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCapability(Utils.unmarshal(response, new TypeReference<Capability>() {}));
                } else {
