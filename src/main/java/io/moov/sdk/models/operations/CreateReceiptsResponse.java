...
public class CreateReceiptsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public CreateReceiptsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CreateReceiptsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateReceiptsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public CreateReceiptsResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateReceiptsResponse other = (CreateReceiptsResponse) o;
        return 
            Utils.enhancedDeepEquals(this.contentType, other.contentType) &&
            Utils.enhancedDeepEquals(this.statusCode, other.statusCode) &&
            Utils.enhancedDeepEquals(this.rawResponse, other.rawResponse) &&
            Utils.enhancedDeepEquals(this.receiptResponses, other.receiptResponses) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            receiptResponses, headers);
    }
    
    @Override
    public String toString() {
        return Utils.toString(CreateReceiptsResponse.class,
    ...
    public final static class Builder {
        ...
        public CreateReceiptsResponse build() {

            return new CreateReceiptsResponse(
                contentType, statusCode, rawResponse,
                receiptResponses, headers);
        }
