...
public class ListAdjustmentsOperation implements RequestOperation<ListAdjustmentsRequest, ListAdjustmentsResponse> {
    ...
    public ListAdjustmentsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAdjustmentsRequest request) throws Exception {
