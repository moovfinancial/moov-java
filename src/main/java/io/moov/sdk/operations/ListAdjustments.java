...
public class ListAdjustments {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListAdjustmentsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdjustmentsRequest, ListAdjustmentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListAdjustmentsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdjustmentsRequest request) throws Exception {
        ...
        @Override
        public ListAdjustmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdjustmentsResponse.Builder resBuilder =
            ...
            ListAdjustmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Adjustment> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAdjustments(out);
                    return res;
                } else {
