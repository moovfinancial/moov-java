...
import io.moov.api.models.components.AsyncTransfer;
import io.moov.api.models.components.CardAcquiringRefund;
import io.moov.api.models.components.CreateRefundResponse;
import io.moov.api.models.components.Reversal;
import io.moov.api.models.components.Transfer;
import io.moov.api.models.components.TransferOptions;
...
import io.moov.api.models.operations.CreateTransferOptionsRequest;
import io.moov.api.models.operations.CreateTransferOptionsRequestBuilder;
...
import io.moov.api.models.operations.CreateTransferRequestBuilder;
import io.moov.api.models.operations.CreateTransferResponse;
import io.moov.api.models.operations.CreateTransferResponseBody;
import io.moov.api.models.operations.CreateTransferSecurity;
import io.moov.api.models.operations.GetRefundRequest;
import io.moov.api.models.operations.GetRefundRequestBuilder;
import io.moov.api.models.operations.GetRefundResponse;
import io.moov.api.models.operations.GetRefundSecurity;
import io.moov.api.models.operations.GetTransferRequest;
import io.moov.api.models.operations.GetTransferRequestBuilder;
import io.moov.api.models.operations.GetTransferResponse;
import io.moov.api.models.operations.GetTransferSecurity;
import io.moov.api.models.operations.ListRefundsRequest;
import io.moov.api.models.operations.ListRefundsRequestBuilder;
...
import io.moov.api.models.operations.ListTransfersRequestBuilder;
import io.moov.api.models.operations.ListTransfersResponse;
import io.moov.api.models.operations.ListTransfersSecurity;
import io.moov.api.models.operations.PatchTransferRequest;
import io.moov.api.models.operations.PatchTransferRequestBuilder;
...
import io.moov.api.models.operations.RefundTransferRequestBuilder;
...
import io.moov.api.models.operations.ReverseTransferRequestBuilder;
...
public class Transfers implements
    ...
    public CreateTransferResponse createTransfer(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "409")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.moov.api.models.errors.Transfer _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<io.moov.api.models.errors.Transfer>() {});
                throw _out;
            } else {
                throw new APIException(
                    _httpRes, 
    ...
    public RefundTransferResponse refundTransfer(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "409")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.moov.api.models.errors.CardAcquiringRefund _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<io.moov.api.models.errors.CardAcquiringRefund>() {});
                throw _out;
            } else {
                throw new APIException(
                    _httpRes, 
