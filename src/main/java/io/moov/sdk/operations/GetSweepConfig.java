...
public class GetSweepConfig {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetSweepConfigRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSweepConfigRequest, GetSweepConfigResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetSweepConfigRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSweepConfigRequest request) throws Exception {
        ...
        @Override
        public GetSweepConfigResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSweepConfigResponse.Builder resBuilder =
            ...
            GetSweepConfigResponse res = resBuilder.build();
