...
public class ListPartnerPricing {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPartnerPricingRequest request) {
        ...
        @Override
        public ListPartnerPricingResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPartnerPricings(Utils.unmarshal(response, new TypeReference<List<PartnerPricing>>() {}));
                } else {
