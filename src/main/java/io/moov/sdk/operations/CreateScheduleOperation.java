...
public class CreateScheduleOperation implements RequestOperation<CreateScheduleRequest, CreateScheduleResponse> {
    ...
    public CreateScheduleOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateScheduleRequest request) throws Exception {
