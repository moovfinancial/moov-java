...
public class CreateInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateInvoiceRequest, CreateInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateInvoiceRequest.class, new TypeReference<CreateInvoiceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateInvoiceRequest request) {
        ...
        @Override
        public CreateInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateInvoiceResponse.Builder resBuilder =
            ...
            CreateInvoiceResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw CreateInvoiceError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
