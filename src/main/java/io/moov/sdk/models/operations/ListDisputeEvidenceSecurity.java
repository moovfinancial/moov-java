...
public class ListDisputeEvidenceSecurity {
    ...
    @JsonCreator
    public ListDisputeEvidenceSecurity(
    ...
    public ListDisputeEvidenceSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListDisputeEvidenceSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListDisputeEvidenceSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListDisputeEvidenceSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListDisputeEvidenceSecurity other = (ListDisputeEvidenceSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListDisputeEvidenceSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListDisputeEvidenceSecurity build() {
            return new ListDisputeEvidenceSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
