...
public class UpdateTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTransferRequest, UpdateTransferResponse> {
        ...
        public HttpResponse<InputStream> doRequest(UpdateTransferRequest request) throws Exception {
            ...
            try {
                ...
                if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "422", "429", "4XX", "500", "504", "5XX")) {
        ...
        public UpdateTransferResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PatchTransferValidationError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
