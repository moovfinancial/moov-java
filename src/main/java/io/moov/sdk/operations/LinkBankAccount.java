...
public class LinkBankAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<LinkBankAccountRequest, LinkBankAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(LinkBankAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LinkBankAccountRequest.class, new TypeReference<LinkBankAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LinkBankAccountRequest request) throws Exception {
        ...
        @Override
        public LinkBankAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LinkBankAccountResponse.Builder resBuilder =
            ...
            LinkBankAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BankAccount out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBankAccount(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BankAccountValidationError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
