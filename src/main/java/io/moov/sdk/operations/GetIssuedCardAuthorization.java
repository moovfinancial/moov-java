...
public class GetIssuedCardAuthorization {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetIssuedCardAuthorizationRequest request) {
        ...
        @Override
        public GetIssuedCardAuthorizationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIssuedCardAuthorization(Utils.unmarshal(response, new TypeReference<IssuedCardAuthorization>() {}));
                } else {
