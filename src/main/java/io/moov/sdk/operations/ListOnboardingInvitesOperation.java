...
public class ListOnboardingInvitesOperation implements RequestOperation<ListOnboardingInvitesRequest, ListOnboardingInvitesResponse> {
    ...
    public ListOnboardingInvitesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListOnboardingInvitesRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListOnboardingInvitesRequest request) throws Exception {
    ...
    @Override
    public ListOnboardingInvitesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListOnboardingInvitesResponse.Builder resBuilder = 
        ...
        ListOnboardingInvitesResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<OnboardingInvite> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withOnboardingInvites(out);
                return res;
            } else {
