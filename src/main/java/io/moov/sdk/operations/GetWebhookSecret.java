...
public class GetWebhookSecret {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWebhookSecretRequest, GetWebhookSecretResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetWebhookSecretRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookSecretRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWebhookSecretRequest request) {
        ...
        @Override
        public GetWebhookSecretResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWebhookSecretResponse.Builder resBuilder =
            ...
            GetWebhookSecretResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWebhookSecret(Utils.unmarshal(response, new TypeReference<WebhookSecret>() {}));
                } else {
