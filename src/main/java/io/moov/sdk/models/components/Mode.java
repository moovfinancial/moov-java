...
public class Mode {
    ...
    public static final Mode SANDBOX = new Mode("sandbox");
    public static final Mode PRODUCTION = new Mode("production");
    ...
    private static final Map<String, ModeEnum> createEnumsMap() {
        ...
        map.put("sandbox", ModeEnum.SANDBOX);
        map.put("production", ModeEnum.PRODUCTION);
        return map;
    }
