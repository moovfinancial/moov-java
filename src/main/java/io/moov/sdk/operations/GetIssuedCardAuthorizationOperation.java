...
public class GetIssuedCardAuthorizationOperation implements RequestOperation<GetIssuedCardAuthorizationRequest, GetIssuedCardAuthorizationResponse> {
    ...
    public GetIssuedCardAuthorizationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetIssuedCardAuthorizationRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetIssuedCardAuthorizationRequest request) throws Exception {
    ...
    @Override
    public GetIssuedCardAuthorizationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetIssuedCardAuthorizationResponse.Builder resBuilder = 
        ...
        GetIssuedCardAuthorizationResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                IssuedCardAuthorization out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withIssuedCardAuthorization(out);
                return res;
            } else {
