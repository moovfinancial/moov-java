...
public class CreateRepresentativeOperation implements RequestOperation<CreateRepresentativeRequest, CreateRepresentativeResponse> {
    ...
    public CreateRepresentativeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRepresentativeRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreateRepresentativeRequest request) throws Exception {
    ...
    @Override
    public CreateRepresentativeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreateRepresentativeResponse.Builder resBuilder = 
        ...
        CreateRepresentativeResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                Representative out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withRepresentative(out);
                return res;
            } else {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                RepresentativeValidationError out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                throw out;
