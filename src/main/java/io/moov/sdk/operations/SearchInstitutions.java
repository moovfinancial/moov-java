...
public class SearchInstitutions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SearchInstitutionsRequest request) {
        ...
        @Override
        public SearchInstitutionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInstitutionsSearchResponse(Utils.unmarshal(response, new TypeReference<InstitutionsSearchResponse>() {}));
                } else {
