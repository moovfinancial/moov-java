...
public class CreateApplePaySession {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateApplePaySessionRequest, CreateApplePaySessionResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateApplePaySessionRequest request) {
        ...
        @Override
        public CreateApplePaySessionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApplePaySession(Utils.unmarshal(response, new TypeReference<String>() {}));
                } else {
