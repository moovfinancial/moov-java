...
public class CompleteMicroDepositsSecurity {
    ...
    @JsonCreator
    public CompleteMicroDepositsSecurity(
    ...
    public CompleteMicroDepositsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CompleteMicroDepositsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CompleteMicroDepositsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CompleteMicroDepositsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CompleteMicroDepositsSecurity other = (CompleteMicroDepositsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CompleteMicroDepositsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CompleteMicroDepositsSecurity build() {
            return new CompleteMicroDepositsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
