...
public class UploadDisputeEvidenceFileOperation implements RequestOperation<UploadDisputeEvidenceFileRequest, UploadDisputeEvidenceFileResponse> {
    ...
    public UploadDisputeEvidenceFileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UploadDisputeEvidenceFileRequest request) throws Exception {
