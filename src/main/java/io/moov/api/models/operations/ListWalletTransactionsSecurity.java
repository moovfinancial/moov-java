...
public class ListWalletTransactionsSecurity {
    ...
    @JsonCreator
    public ListWalletTransactionsSecurity(
    ...
    public ListWalletTransactionsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListWalletTransactionsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListWalletTransactionsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListWalletTransactionsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListWalletTransactionsSecurity other = (ListWalletTransactionsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListWalletTransactionsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListWalletTransactionsSecurity build() {
            return new ListWalletTransactionsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
