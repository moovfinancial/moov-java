...
public class GetEnrichmentAddress {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEnrichmentAddressRequest, GetEnrichmentAddressResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetEnrichmentAddressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEnrichmentAddressRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEnrichmentAddressRequest request) {
        ...
        @Override
        public GetEnrichmentAddressResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnrichedAddressResponse(Utils.unmarshal(response, new TypeReference<EnrichedAddressResponse>() {}));
                } else {
