...
public class ListIssuedCardAuthorizationsSecurity {
    ...
    @JsonCreator
    public ListIssuedCardAuthorizationsSecurity(
    ...
    public ListIssuedCardAuthorizationsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public ListIssuedCardAuthorizationsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public ListIssuedCardAuthorizationsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public ListIssuedCardAuthorizationsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListIssuedCardAuthorizationsSecurity other = (ListIssuedCardAuthorizationsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListIssuedCardAuthorizationsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public ListIssuedCardAuthorizationsSecurity build() {
            return new ListIssuedCardAuthorizationsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
