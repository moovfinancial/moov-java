...
public class ListSweeps {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListSweepsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSweepsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSweepsRequest request) {
        ...
        @Override
        public ListSweepsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSweeps(Utils.unmarshal(response, new TypeReference<List<Sweep>>() {}));
                } else {
