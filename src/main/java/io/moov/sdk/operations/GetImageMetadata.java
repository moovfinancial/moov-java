...
public class GetImageMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetImageMetadataRequest, GetImageMetadataResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetImageMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetImageMetadataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetImageMetadataRequest request) throws Exception {
        ...
        @Override
        public GetImageMetadataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetImageMetadataResponse.Builder resBuilder =
            ...
            GetImageMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ImageMetadata out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
