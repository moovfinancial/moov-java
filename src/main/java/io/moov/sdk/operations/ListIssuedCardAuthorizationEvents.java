...
public class ListIssuedCardAuthorizationEvents {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListIssuedCardAuthorizationEventsRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListIssuedCardAuthorizationEventsRequest, ListIssuedCardAuthorizationEventsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListIssuedCardAuthorizationEventsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListIssuedCardAuthorizationEventsRequest request) throws Exception {
        ...
        @Override
        public ListIssuedCardAuthorizationEventsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListIssuedCardAuthorizationEventsResponse.Builder resBuilder =
            ...
            ListIssuedCardAuthorizationEventsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<IssuedCardAuthorizationEvent> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIssuedCardAuthorizationEvents(out);
                    return res;
                } else {
