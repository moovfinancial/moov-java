...
public class SendFundsWire {
    ...
    public SendFundsWire withEstimatedActivity(EstimatedActivity estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
    ...
    public SendFundsWire withEstimatedActivity(Optional<? extends EstimatedActivity> estimatedActivity) {
        Utils.checkNotNull(estimatedActivity, "estimatedActivity");
        this.estimatedActivity = estimatedActivity;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SendFundsWire other = (SendFundsWire) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SendFundsWire.class,
    ...
    public final static class Builder {
        ...
        public SendFundsWire build() {

            return new SendFundsWire(
                estimatedActivity);
        }
