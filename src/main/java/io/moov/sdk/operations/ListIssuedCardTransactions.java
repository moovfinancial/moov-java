...
public class ListIssuedCardTransactions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListIssuedCardTransactionsRequest, ListIssuedCardTransactionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListIssuedCardTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListIssuedCardTransactionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListIssuedCardTransactionsRequest request) {
        ...
        @Override
        public ListIssuedCardTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIssuedCardTransactions(Utils.unmarshal(response, new TypeReference<List<IssuedCardTransaction>>() {}));
                } else {
