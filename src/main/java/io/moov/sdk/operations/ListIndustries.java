...
public class ListIndustries {
    ...
    public static class Sync extends Base
        ...
        @Override
        public ListIndustriesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnrichedIndustries(Utils.unmarshal(response, new TypeReference<EnrichedIndustries>() {}));
                } else {
