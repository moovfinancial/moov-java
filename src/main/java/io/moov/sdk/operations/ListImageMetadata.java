...
public class ListImageMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListImageMetadataRequest, ListImageMetadataResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListImageMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListImageMetadataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListImageMetadataRequest request) throws Exception {
        ...
        @Override
        public ListImageMetadataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListImageMetadataResponse.Builder resBuilder =
            ...
            ListImageMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ImageMetadata> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withImageMetadata(out);
                    return res;
                } else {
