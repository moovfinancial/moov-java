...
public class RequestCard {
    ...
    public static class Sync extends Base
            implements RequestOperation<RequestCardRequest, RequestCardResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RequestCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RequestCardRequest.class, new TypeReference<RequestCardRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RequestCardRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "422", "429", "4XX", "500", "504", "5XX")) {
        ...
        @Override
        public RequestCardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RequestCardResponse.Builder resBuilder =
                    RequestCardResponse
                            .builder()
            ...
            RequestCardResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    IssuedCard out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIssuedCard(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RequestCardError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
