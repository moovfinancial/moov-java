...
public class CompleteMicroDepositsOperation implements RequestOperation<CompleteMicroDepositsRequest, CompleteMicroDepositsResponse> {
    ...
    public CompleteMicroDepositsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CompleteMicroDepositsRequest request) throws Exception {
