...
public class GetPublicImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPublicImageRequest, GetPublicImageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPublicImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPublicImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPublicImageRequest request) throws Exception {
        ...
        @Override
        public GetPublicImageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPublicImageResponse.Builder resBuilder =
            ...
            GetPublicImageResponse res = resBuilder.build();
