...
public class AssignAccountCountriesOperation implements RequestOperation<AssignAccountCountriesRequest, AssignAccountCountriesResponse> {
    ...
    public AssignAccountCountriesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AssignAccountCountriesRequest request) throws Exception {
