...
public class CreateFeePlanAgreementsSecurity {
    ...
    @JsonCreator
    public CreateFeePlanAgreementsSecurity(
    ...
    public CreateFeePlanAgreementsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public CreateFeePlanAgreementsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public CreateFeePlanAgreementsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public CreateFeePlanAgreementsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateFeePlanAgreementsSecurity other = (CreateFeePlanAgreementsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateFeePlanAgreementsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public CreateFeePlanAgreementsSecurity build() {
            return new CreateFeePlanAgreementsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
