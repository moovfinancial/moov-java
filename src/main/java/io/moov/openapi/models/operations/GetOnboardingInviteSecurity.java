...
public class GetOnboardingInviteSecurity {
    ...
    @JsonCreator
    public GetOnboardingInviteSecurity(
    ...
    public GetOnboardingInviteSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetOnboardingInviteSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetOnboardingInviteSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetOnboardingInviteSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOnboardingInviteSecurity other = (GetOnboardingInviteSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetOnboardingInviteSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetOnboardingInviteSecurity build() {
            return new GetOnboardingInviteSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
