...
public class GetResolutionLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetResolutionLinkRequest, GetResolutionLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetResolutionLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetResolutionLinkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetResolutionLinkRequest request) {
        ...
        @Override
        public GetResolutionLinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetResolutionLinkResponse.Builder resBuilder =
            ...
            GetResolutionLinkResponse res = resBuilder.build();
