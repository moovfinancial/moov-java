...
public class ListSchedules {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListSchedulesRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSchedulesRequest, ListSchedulesResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListSchedulesRequest request) throws Exception {
