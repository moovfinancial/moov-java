...
public class LinkAccountTerminalApplicationOperation implements RequestOperation<LinkAccountTerminalApplicationRequest, LinkAccountTerminalApplicationResponse> {
    ...
    public LinkAccountTerminalApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(LinkAccountTerminalApplicationRequest request) throws Exception {
