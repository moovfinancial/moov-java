...
public class InitiateBankAccountVerificationSecurity {
    ...
    @JsonCreator
    public InitiateBankAccountVerificationSecurity(
    ...
    public InitiateBankAccountVerificationSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public InitiateBankAccountVerificationSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public InitiateBankAccountVerificationSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public InitiateBankAccountVerificationSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InitiateBankAccountVerificationSecurity other = (InitiateBankAccountVerificationSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InitiateBankAccountVerificationSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public InitiateBankAccountVerificationSecurity build() {
            return new InitiateBankAccountVerificationSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
