...
public class UploadImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadImageRequest, UploadImageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UploadImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadImageRequest.class, new TypeReference<UploadImageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadImageRequest request) {
        ...
        @Override
        public UploadImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadImageResponse.Builder resBuilder =
                    UploadImageResponse
                            .builder()
            ...
            UploadImageResponse res = resBuilder.build();
