...
public class InitiateMicroDepositsSecurity {
    ...
    @JsonCreator
    public InitiateMicroDepositsSecurity(
    ...
    public InitiateMicroDepositsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public InitiateMicroDepositsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public InitiateMicroDepositsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public InitiateMicroDepositsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InitiateMicroDepositsSecurity other = (InitiateMicroDepositsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InitiateMicroDepositsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public InitiateMicroDepositsSecurity build() {
            return new InitiateMicroDepositsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
