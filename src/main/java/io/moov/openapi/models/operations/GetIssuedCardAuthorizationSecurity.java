...
public class GetIssuedCardAuthorizationSecurity {
    ...
    @JsonCreator
    public GetIssuedCardAuthorizationSecurity(
    ...
    public GetIssuedCardAuthorizationSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public GetIssuedCardAuthorizationSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public GetIssuedCardAuthorizationSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public GetIssuedCardAuthorizationSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetIssuedCardAuthorizationSecurity other = (GetIssuedCardAuthorizationSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetIssuedCardAuthorizationSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public GetIssuedCardAuthorizationSecurity build() {
            return new GetIssuedCardAuthorizationSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
