...
public class CreateReversal {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateReversalRequest, CreateReversalResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateReversalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateReversalRequest.class, new TypeReference<CreateReversalRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateReversalRequest request) throws Exception {
        ...
        @Override
        public CreateReversalResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateReversalResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ReversalValidationError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
