...
public class ListRefundsOperation implements RequestOperation<ListRefundsRequest, ListRefundsResponse> {
    ...
    public ListRefundsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListRefundsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListRefundsRequest request) throws Exception {
    ...
    @Override
    public ListRefundsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListRefundsResponse.Builder resBuilder = 
            ListRefundsResponse
                .builder()
        ...
        ListRefundsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            res.withHeaders(response.headers().map());
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                List<CardAcquiringRefund> out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withCardAcquiringRefunds(out);
                return res;
            } else {
