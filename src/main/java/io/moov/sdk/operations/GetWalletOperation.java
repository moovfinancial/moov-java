...
public class GetWalletOperation implements RequestOperation<GetWalletRequest, GetWalletResponse> {
    ...
    public GetWalletOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetWalletRequest request) throws Exception {
