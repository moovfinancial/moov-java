...
public class DisconnectAccountRequest {
     ...
     * Specify an API version.
     */
    public DisconnectAccountRequest withXMoovVersion(Versions xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
     ...
     * Specify an API version.
     */
    public DisconnectAccountRequest withXMoovVersion(Optional<? extends Versions> xMoovVersion) {
        Utils.checkNotNull(xMoovVersion, "xMoovVersion");
        this.xMoovVersion = xMoovVersion;
        return this;
    }

    public DisconnectAccountRequest withAccountID(String accountID) {
        Utils.checkNotNull(accountID, "accountID");
        this.accountID = accountID;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(DisconnectAccountRequest.class,
    ...
    public final static class Builder {
        ...
        public DisconnectAccountRequest build() {
            return new DisconnectAccountRequest(
                xMoovVersion,
                accountID);
        }
    }
