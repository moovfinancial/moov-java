...
public class ListTickets {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTicketsRequest, ListTicketsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketsRequest request) {
        ...
        @Override
        public ListTicketsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListTicketsResponseBody>() {}));
                } else {
