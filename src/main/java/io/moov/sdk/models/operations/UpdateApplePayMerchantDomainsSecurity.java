...
public class UpdateApplePayMerchantDomainsSecurity {
    ...
    @JsonCreator
    public UpdateApplePayMerchantDomainsSecurity(
    ...
    public UpdateApplePayMerchantDomainsSecurity withBasicAuth(SchemeBasicAuth basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = Optional.ofNullable(basicAuth);
        return this;
    }

    public UpdateApplePayMerchantDomainsSecurity withBasicAuth(Optional<? extends SchemeBasicAuth> basicAuth) {
        Utils.checkNotNull(basicAuth, "basicAuth");
        this.basicAuth = basicAuth;
        return this;
    }

    public UpdateApplePayMerchantDomainsSecurity withOAuth2Auth(String oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = Optional.ofNullable(oAuth2Auth);
        return this;
    }

    public UpdateApplePayMerchantDomainsSecurity withOAuth2Auth(Optional<String> oAuth2Auth) {
        Utils.checkNotNull(oAuth2Auth, "oAuth2Auth");
        this.oAuth2Auth = oAuth2Auth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateApplePayMerchantDomainsSecurity other = (UpdateApplePayMerchantDomainsSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateApplePayMerchantDomainsSecurity.class,
                "basicAuth", basicAuth,
    ...
    public final static class Builder {
        ...
        public UpdateApplePayMerchantDomainsSecurity build() {
            return new UpdateApplePayMerchantDomainsSecurity(
                basicAuth,
                oAuth2Auth);
        }
    }
