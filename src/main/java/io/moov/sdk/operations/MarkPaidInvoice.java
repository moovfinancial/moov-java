...
public class MarkPaidInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarkPaidInvoiceRequest, MarkPaidInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(MarkPaidInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarkPaidInvoiceRequest.class, new TypeReference<MarkPaidInvoiceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarkPaidInvoiceRequest request) {
        ...
        @Override
        public MarkPaidInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarkPaidInvoiceResponse.Builder resBuilder =
            ...
            MarkPaidInvoiceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvoice(Utils.unmarshal(response, new TypeReference<Invoice>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw MarkInvoicePaidError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
