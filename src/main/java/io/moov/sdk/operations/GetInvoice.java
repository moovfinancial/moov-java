...
public class GetInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInvoiceRequest, GetInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInvoiceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInvoiceRequest request) {
        ...
        @Override
        public GetInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInvoiceResponse.Builder resBuilder =
                    GetInvoiceResponse
                            .builder()
            ...
            GetInvoiceResponse res = resBuilder.build();
