...
public class AssignAccountCountries {
    ...
    public static class Sync extends Base
            implements RequestOperation<AssignAccountCountriesRequest, AssignAccountCountriesResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(AssignAccountCountriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AssignAccountCountriesRequest.class, new TypeReference<AssignAccountCountriesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AssignAccountCountriesRequest request) throws Exception {
        ...
        @Override
        public AssignAccountCountriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AssignAccountCountriesResponse.Builder resBuilder =
            ...
            AssignAccountCountriesResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AssignCountriesError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
