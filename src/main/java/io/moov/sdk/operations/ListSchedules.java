...
public class ListSchedules {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSchedulesRequest request) {
        ...
        @Override
        public ListSchedulesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScheduleListResponses(Utils.unmarshal(response, new TypeReference<List<ScheduleListResponse>>() {}));
                } else {
